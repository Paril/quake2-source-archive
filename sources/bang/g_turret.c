...
void turret_breach_fire (edict_t *self)
{
	...
	fire_nukegrenade2 (self->teammaster->owner, start, f, damage, speed, 1, damage, false);
	gi.positioned_sound (start, self, CHAN_AUTOON, gi.soundindex("weapons/rocklf1a.wav"), 1, ATTN_NORM, 0);
}
