...
# ADD CPP /nologo /G6 /MT /W3 /GX /O2 /Ob2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /FD /c
# SUBTRACT CPP /Fr /YX
MTL=midl.exe
...
# ADD LINK32 kernel32.lib user32.lib /nologo /base:"0x20000000" /subsystem:windows /dll /pdb:none /machine:I386 /out:"./output/release/gamex86.dll"
...
# ADD LINK32 kernel32.lib user32.lib winmm.lib /nologo /base:"0x20000000" /subsystem:windows /dll /incremental:no /pdb:"./output/debug/gamex86.pdb" /map:"./output/debug/gamex86.map" /debug /machine:I386 /out:"./output/debug/gamex86.dll" /fixed:no
