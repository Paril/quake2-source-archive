...
{
	gi.sound (self, CHAN_AUTO, sound_search, 1, ATTN_NORM, 0);
}
...
void berserk_fidget (edict_t *self)
{
	...
	gi.sound (self, CHAN_AUTOON, sound_idle, 1, ATTN_IDLE, 0);
}
...
{
	gi.sound (self, CHAN_AUTOON, sound_punch, 1, ATTN_NORM, 0);
}
...
void berserk_die (edict_t *self, edict_t *inflictor, edict_t *attacker, int damage, vec3_t point)
{
	...
	gi.sound (self, CHAN_AUTO, sound_die, 1, ATTN_NORM, 0);
	self->deadflag = DEAD_DEAD;
