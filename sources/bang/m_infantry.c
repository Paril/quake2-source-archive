...
void infantry_cock_gun (edict_t *self)
{
	...
	gi.sound (self, CHAN_AUTOON, sound_weapon_cock, 1, ATTN_NORM, 0);
	n = (rand() & 15) + 3 + 7;
...
{
	gi.sound (self, CHAN_AUTOON, sound_punch_swing, 1, ATTN_NORM, 0);
}
...
void infantry_smack (edict_t *self)
{
	...
	if (fire_hit (self, aim, (5 + (rand() % 5)), 50))
		gi.sound (self, CHAN_AUTOON, sound_punch_hit, 1, ATTN_NORM, 0);
}
