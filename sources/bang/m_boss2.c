...
{
	if (random() < 0.5)
		gi.sound (self, CHAN_AUTO, sound_search1, 1, ATTN_NONE, 0);
}
...
// American wanted these at no attenuation
	if (damage < 10)
	{
		gi.sound (self, CHAN_AUTO, sound_pain3, 1, ATTN_NONE, 0);
		self->monsterinfo.currentmove = &boss2_move_pain_light;
	}
	else if (damage < 30)
	{
		gi.sound (self, CHAN_AUTO, sound_pain1, 1, ATTN_NONE, 0);
		self->monsterinfo.currentmove = &boss2_move_pain_light;
	}
	else 
	{
		gi.sound (self, CHAN_AUTO, sound_pain2, 1, ATTN_NONE, 0);
...
void boss2_die (edict_t *self, edict_t *inflictor, edict_t *attacker, int damage, vec3_t point)
{
	gi.sound (self, CHAN_AUTO, sound_death, 1, ATTN_NONE, 0);
	...
	{
		gi.sound (self, CHAN_AUTO, gi.soundindex ("misc/udeath.wav"), 1, ATTN_NORM, 0);
		for (n= 0; n < 2; n++)
