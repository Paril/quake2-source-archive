...
/*
	0x001 = very quickly evaporating red/orange trail with small light radius
	0x002 = gold trail
	0x004 = huge white light radius
	0x008 = model spins on side, throwing light in facing direction
	0x01 = light-emitting translucent model 
	0x02 = gold vertical particle fountain
	0x04 = dark radius, black trail
	0x08 = amber shell
	0x1 = almost completely invisible model, no light
	0x2 = wide yellow particle trail, similar to tport effect
	0x4 = light green shell
	0x8 = black particle sphere
*/
...
// Expert: Player ID stat string
#define STAT_PLAYER_ID			27
...
// Expert we want playerid to display just a player's name.
// After the array of name/model/skin comes an array of 
// just the player names, greentexted.
#define CS_PLAYERNAMES		(MAX_CONFIGSTRINGS)
