...
void InitGame (void)
{
	...
	sv_bodyguards=gi.cvar("sv_bodyguards","1",CVAR_SERVERINFO|CVAR_LATCH);
	...
	team_dm = gi.cvar ("team_dm", "0", CVAR_LATCH);

	// change anytime vars
	locklights = gi.cvar ("locklights", "1", CVAR_SERVERINFO);
...
//PSY: CTF
	...
	game.maxentities = CVAR_MAX_ENTITIES;
	g_edicts =  gi.TagMalloc (game.maxentities * sizeof(g_edicts[0]), TAG_GAME);
	globals.edicts = g_edicts;
	globals.max_edicts = game.maxentities;

	// initialize all clients for this game
	game.maxclients = CVAR_MAXCLIENTS;
...
void ReadLevel (char *filename)
{
	...
	globals.num_edicts = CVAR_MAXCLIENTS+1;
