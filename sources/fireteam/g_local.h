...
typedef enum
{
	...
	WEAPON_FIRING,
    WEAPON_END_MAG,
	WEAPON_START_RELOADING,
	WEAPON_END_RELOADING,
    WEAPON_RELOADING
} weaponstate_t;
...
#define	IT_AMMO			2
#define IT_ARMOR		4
#define IT_STAY_COOP	8		// not used
#define IT_KEY			16
...
#define	MOD_PIPEBOMB		35
#define	MOD_SHRAPNEL		36
#define MOD_GAS_GRENADE		37
#define	MOD_GUIDED			38
#define	MOD_HOMING			39
#define	MOD_DEFENSE_LASER	40
#define	MOD_C4				41
#define	MOD_LASERFENCE		42
#define MOD_ROCKET_BOMBS	43 // Rocket Airstrike
#define MOD_CLUSTER_BOMBS	44 // Cluster Airstrike
...
//PSY: CTF
extern	cvar_t	*team_dm;
extern	cvar_t	*locklights;
...
#define INFANTRY		1
#define	RECON			2
#define	LIGHT_ASSAULT	3
#define HEAVY_DEFENSE	4
#define	SEAL			5
#define	ENGINEER		6
#define	SNIPER			7
#define	DEMOLITIONS		8
#define MEDIC			9
...
#define IS_RUNNING		sqrt(ent->velocity[0]*ent->velocity[0] + ent->velocity[1]*ent->velocity[1])
#define	STATE_PLAYING		1
#define	STATE_NEWCLASS		2
...
typedef struct
{
    int                     score; // total frags, etc
    int                     team;
	int                     ctf_team;
    int                     class;
    char                    ip[30]; // stores the client's ip address
    float                   timeout; // time when this save slot expires
} saved_info;

saved_info saved_client[15]; //holds data for 15 clients, increase this if necessary
...
//PSY: CTF
	...
	int			hb_rds;
	int			rail_rds;
	int			bfg_rds; // why do we need this?

	int			reload_time;

    float           blindTime, blindBase;

	int			concussion_toggle;
	int			pipe_toggle;
	int			shrapnel_toggle;
	int			recon_grenade_toggle;
	int			rocket_toggle;
	int			teleport_toggle;
...
struct edict_s
{
	...
	int loadinfo; //instructs game to load a clients info from a saved record
	...
	int airstrike_type; // 1=Rocket, 2=Cluster, 3=BFG Nuke, etc.
};
