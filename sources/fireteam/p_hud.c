...
void HelpComputer (edict_t *ent)
{
	...
	if (CVAR_SKILL_LEVEL == 0)
		sk = "easy";
	else if (CVAR_SKILL_LEVEL == 1)
		sk = "medium";
	else if (CVAR_SKILL_LEVEL == 2)
		sk = "hard";
	else
		sk = "hard+";
...
void G_SetStats (edict_t *ent)
{
    ...
    {
	    ent->client->ps.stats[STAT_HEAL] = ent->client->pers.heal_health;
    }
	...
	if (power_armor_type)
	{
		...
		{	// ran out of cells for power armor
			...
			gi.sound(ent, CHAN_ITEM, POWER2_SOUND, 1, ATTN_NORM, 0);
			power_armor_type = 0;;
		}
	}
