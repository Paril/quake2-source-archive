...
mmove_t parasite_move_jump_up = { FRAME_run03, FRAME_run09, parasite_frames_jump_up, parasite_run };
...
mmove_t parasite_move_jump_down = { FRAME_run03, FRAME_run09, parasite_frames_jump_down, parasite_run };
...
void SP_monster_parasite (edict_t *self)
{
	...
	self->monsterinfo.scale = MODEL_SCALE;
        ...
        //Wyrm: respawn
        self->monsterinfo.spawn = SP_monster_parasite;
