...
//Wyrm: new tail attack
void flipper_tail (edict_t *self)
{
	vec3_t	aim;
...
mframe_t flipper_frames_attack2 [] =
{
	ai_charge, 0,	flipper_preattack,
	ai_charge, 0,	NULL,
	ai_charge, 0,	NULL,
...
mmove_t flipper_move_attack2 = {FRAME_flptal01, FRAME_flptal21, flipper_frames_attack2, flipper_run};
...
void flipper_melee(edict_t *self)
{
        if (random() < .5)
                ...
                self->monsterinfo.currentmove = &flipper_move_attack2;
...
void SP_monster_flipper (edict_t *self)
{
	...
	self->monsterinfo.scale = MODEL_SCALE;
        ...
        //Wyrm: respawn
        self->monsterinfo.spawn = SP_monster_flipper;
