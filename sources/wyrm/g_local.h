...
#define GAMEVERSION     "Wyrm 2 - World of Destruction"
...
//RWS: dropper spawnflag
#define SPAWNFLAG_IGNORE_RWS                      0x00002000
...
//Wyrm: power screen
#define FL_POWER_SCREEN                 0x00002000      // power armor (if any) is active
//Wyrm: frozen
#define FL_FROZEN                       0x00004000      // power armor (if any) is active
#define FL_WASFLYING                   0x00008000      // power armor (if any) is active
//Wyrm: flare
#define FL_FLARE                      0x00010000      
...
//Wyrm: new mods
#define MOD_FREEZE              34
#define MOD_PISTOL              35
#define MOD_FLAREGUN            36
#define MOD_AIRFIST             37
#define MOD_DOUBLEIMPACT        38
#define MOD_EXPLOSIVEMACHINEGUN 39
#define MOD_PULSERIFLE          40
#define MOD_FIRETHROWER         41
#define MOD_STREETSWEEPER       42
#define MOD_CLUSTERGRENADES     43
#define MOD_RAILGRENADES        44
#define MOD_PROXGRENADES        45
#define MOD_NAPALMGRENADES      46
#define MOD_STICKINGGRENADES    47
#define MOD_BFGRENADES          48
#define MOD_NAPALMROCKETS       49
#define MOD_GUIDEDROCKETS       50
#define MOD_PLASMA              51
#define MOD_DISRUPTOR           52
#define MOD_ANTIMATTER          53
#define MOD_POSITRON            54
#define MOD_TRIPBOMB            55
#define MOD_LASERTRIPBOMB       56
#define MOD_GRAPPLE             57
#define MOD_FIRE                58
#define MOD_FIRE_SPLASH         59
#define MOD_ON_FIRE             60
#define MOD_FIREBALL            61
#define MOD_NAIL                62
#define MOD_SUPERNAIL           63
#define MOD_VACUUM              64
#define MOD_VORTEX              65
#define MOD_DRAINER             66
#define MOD_BUCKY               67
#define MOD_LIGHTNING           68
#define MOD_DISCHARGE           69
#define MOD_PERFORATOR          70
#define MOD_PERFORATOR_SPLASH   71
#define MOD_NUKE                72
#define MOD_SENTRYEXPLODE       73
#define MOD_SENTRYBULLET        74
...
//Wyrm: class
extern  cvar_t  *classfile;
extern  cvar_t  *setclassskin;
extern  cvar_t  *enableclass;
//Wyrm: misc
extern  cvar_t *footsteps;
extern  cvar_t *changeframes;
extern  cvar_t *dropitems;
extern  cvar_t *offhandgrapple;
extern  cvar_t *start_666_time;
extern  cvar_t *autokeybinding;
extern  cvar_t *cam_force;
extern  cvar_t *maxshells;
extern  cvar_t *maxbulletholes;
extern  cvar_t *tempents_timelimit;
...
//eavy: ctf
extern  cvar_t  *ctf_autoflagspawn;
extern  cvar_t  *ctf_autospawnnearflag;
...
//Wyrm: explosive machinegun has a bigger spread
...
//Wyrm: new rocket types
void monster_fire_flamerocket (edict_t *self, vec3_t start, vec3_t dir, int damage, int speed, int flashtype);
void monster_fire_homingrocket (edict_t *self, vec3_t start, vec3_t dir, int damage, int speed, int flashtype);
void monster_fire_perforator (edict_t *self, vec3_t start, vec3_t dir, int damage, int speed, int flashtype);
...
//Wyrm
void MonsterRespawn (edict_t *self);
void SetMonsterRespawn (edict_t *self);
...
//ZOID
        ...
        int class;
//Wyrm: class menus
        int tempclass; //for menus
        int offset; //for initial inventory info menus

        qboolean class_selected;
        int keysbinded;
} client_respawn_t;
...
//Wyrm: class speed, power, resistance, jump, knockback
        float           ClassSpeed;
        float           ClassPower;
        float           ClassResistance;
        float           ClassJump;
        float           ClassKnockback;
//Wyrm: iceball
        edict_t         *iceball;
/* _________ *\
** ¯¯¯¯¯¯¯¯¯ **
...
/*-----/ PM /-----/ NEW:  Extra fields used in Napalm2 mod. /-----*/
        ...
        edict_t         *burner;
/*----------------------------------------------------------------*/
//Wyrm!--> new stuff that regules a "second thinking" (used for freeze)
...
// Random Weapon Spawn
//-----------------------------------------------------------------------
#define		__RANDOM_WEAPON_SPAWN__
#define		__GENERATE_DEFAULT_TABLE__
#define		MAX_RANDOM_WEAPON							16
#define         RND_CFG_IN                                                                      "default.rws"
#define		RND_CFG_OUT									"rw.log"
#define		LINE_SIZE									128

extern		cvar_t										*cv_rwcfgin,
														*cv_rwcfgout,
														*cv_rwcfgdef,
														*cv_game;
...
typedef struct
{
	struct gitem_s	* rnd_item[MAX_RANDOM_WEAPON];
...
typedef struct
{
        ...
        int                             inventory[MAX_ITEMS];
        //Wyrm: mods
        float                           inflict[MOD_LAST];
        float                           receive[MOD_LAST];
        //Wyrm: initial weapon :P
        gitem_t                         *initial_weapon;
        //Wyrm: class armors
...
typedef struct d_MDam_s
{
        char name[32];
        int MOD;
} d_MDam;

//BEGIN! - Turret! --> turret defines
//turret valors...

#define TURRET_ROCKET           0
#define TURRET_CHAINGUN         1
#define TURRET_RAILGUN          2
#define TURRET_PLASMA           3
#define TURRET_BLASTER          4
#define TURRET_NEOBLASTER       5
//END! - Turret!

// scanner consts & macros
#define	SCANNER_UNIT                   32
#define SCANNER_RANGE                  24
#define	SCANNER_UPDATE_FREQ            1
#define SCANNER_FRAMES_PER_CELL        8
#define PIC_SCANNER                    "s"
#define PIC_SCANNER_TAG                "s"
#define PIC_DOT                        "a"
#define PIC_DOT_TAG                    "a"
#define PIC_DOT_UP                     "c"
#define PIC_DOT_UP_TAG                 "c"
#define PIC_DOT_DOWN                   "b"
#define PIC_DOT_DOWN_TAG               "b"
#define PIC_INVDOT                     "d"
#define PIC_INVDOT_TAG                 "d"
#define PIC_INVDOT_UP                  "f"
#define PIC_INVDOT_UP_TAG              "f"
#define PIC_INVDOT_DOWN                "e"
#define PIC_INVDOT_DOWN_TAG            "e"
#define PIC_QUADDOT                    "g"
#define PIC_QUADDOT_TAG                "g"
#define PIC_QUADDOT_UP                 "i"
#define PIC_QUADDOT_UP_TAG             "i"
#define PIC_QUADDOT_DOWN               "h"
#define PIC_QUADDOT_DOWN_TAG           "h"
#define PIC_TECHDOT                    "j"
#define PIC_TECHDOT_TAG                "j"
#define PIC_TECHDOT_UP                 "l"
#define PIC_TECHDOT_UP_TAG             "l"
#define PIC_TECHDOT_DOWN               "k"
#define PIC_TECHDOT_DOWN_TAG           "k"
#define PIC_HEALTHDOT                  "m"
#define PIC_HEALTHDOT_TAG              "m"
#define PIC_HEALTHDOT_UP               "o"
#define PIC_HEALTHDOT_UP_TAG           "o"
#define PIC_HEALTHDOT_DOWN             "n"
#define PIC_HEALTHDOT_DOWN_TAG         "n"
#define PIC_BLUE_ROUND                 "y"
#define PIC_RED_ROUND                  "z"

#define	SAFE_STRCAT(org,add,maxlen)    if ((strlen(org) + strlen(add)) < maxlen)    strcat(org,add);
#define LAYOUT_MAX_LENGTH              1200

#define TBOMB_MAX_EXIST 15
