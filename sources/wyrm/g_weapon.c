...
//BEGIN! - Turret! --> is he in a turret?
	...
	if (self->client)
        {
        	...
        	check_dodge (self, bolt->s.origin, dir, speed);
                ...
                if (self->flags & FL_TEAMSLAVE) /*this has to work... :P*/
                        is_onturret = true;
...
void bfg_think (edict_t *self)
{
	...
	trace_t	tr;
        ...
        if (self->owner)
                if (self->owner->client)
                        if (!classtbl[ParseClass(self->owner->client->resp.class)].inflict[MOD_BFG_LASER])
                                bfglaser = false;
