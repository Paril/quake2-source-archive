...
These functions allow quicker access to 5 game import stuff.
...
2 =	ATTN_IDLE // A bit lower an normal
...
==================
*/
void simple_trace (edict_t *trace_shooter, int distance)
{
	vec3_t  start;
	vec3_t  forward;
	vec3_t  end;
