...
//peewee start
//gemini laser
//Special thanks to Steve M
//http://webadvisor.aupr.edu/noc/Othertutorials/qdevels/-%20Bouncy%20Gun.html
MOVETYPE_FLYBOUNCE,		//
//peewe end
...
#define MOD_BUSTER			34
#define MOD_DUST			35
#define MOD_SHRAPNEL		36
#define MOD_SKULL			37
#define MOD_CRASHB			38
#define MOD_CUTTER			39
#define MOD_BOMB_EXP		40
#define MOD_MAGNET			41
#define MOD_MAGNET_R		42
#define MOD_NEEDLE			43
#define MOD_GEMINI			44
#define	MOD_SABRE			45
#define	MOD_SABRE_BLAST		46
#define	MOD_SARMOR			47
...
typedef struct
{
	...
	float		charge;
	float		chargesnd;
	//sliding variable. Can only slide once per duck
	qboolean	sliding;
	float		slide_time;
	qboolean	airsliding;
	...
	// ENH_BLAST = Offhand Blaster. Replaces silencer. Used and charged by pressing +use
	float		charge_2;
	float		blast_time;
...
struct edict_s
{
	...
	//peewee start
	//old model infor for tank
	int		oldmodelindex;
	int		oldmodel2index;
	int		oldgunindex;
	//old health and armor for tank
	int		oldhealth;
	int		oldarmorcount;
	int		oldarmortype;
