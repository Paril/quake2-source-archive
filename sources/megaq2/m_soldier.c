...
//peewee start
	...
	gitem_t *item;
	edict_t *monster;
	if (strcmp(self->classname, "Shotgun") == 0)
	{
		...
		if (deathmatch->value)
		{
			...
			self->activator->item = item;
			self->activator->think = ItemSpawnMonsterTimer;
			self->activator->nextthink = level.time + 14;
		}
	}
	else if (strcmp(self->classname, "Machinegun") == 0)
	{
