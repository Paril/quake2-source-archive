...
void Cmd_Drop_f (edict_t *ent)
{
	...
	//let them drop powerup
	if (Q_stricmp (s, "enhancement") == 0 ||
		Q_stricmp (s, "tech") == 0 ||
		Q_stricmp (s, "powerup") == 0 ||
		Q_stricmp (s, "power") == 0)
	{
		//cannot drop tank
		if (ent->client->pers.enhance == ENH_RTANK)
		{
	   		gi.cprintf (ent, PRINT_HIGH, "Cannot Drop Tank\n");
			return;
		}
		//clear enhance
		...
		//tell player
   		gi.cprintf (ent, PRINT_HIGH, "Enhancement Dropped\n");
		return;
	}
