...
/* *** BRRR STATUSBAR *** */
/* This has been moved into C_BRRR.C */
...
void CTFInit(void)
{
    /* *** Tom: Changed to CVAR_SERVERINFO|CVAR_LATCH|CVAR_ARCHIVE */
    ctf = gi.cvar("ctf", "1", CVAR_SERVERINFO|CVAR_LATCH|CVAR_ARCHIVE);
...
//    if (team1count < team1count)  - TOM: WTF?!
...
edict_t *SelectCTFSpawnPoint (edict_t *ent)
{
    ...
    /* *** Always start in base if DF_ANN_CTF_BASESTART *** */
    if (ent->client->resp.ctf_state != CTF_STATE_START /**/&& !((int)(dmflags->value) & DF_ANN_CTF_BASESTART)/**/)
...
////
    ...
    /* *** Tom: Disarm proximity mines/pipebombs *** */
    disarm(ent);
}
    ...
    *string = 0;
...
#else
            /* *** DEVMODE *** */
            if (cl->resp.allow_devmode)
            {
                sprintf(entry+strlen(entry),
                "xv 64 yv %d picn adms ", 40 + i * 8);
            }
            /* *** */
    ...
    if (maxsize - len > 50) {
        for (i = 0; i < maxclients->value; i++) {
            ...
            {
                sprintf(entry+strlen(entry),
                "xv %d yv %d picn adms ", (n & 1)?224:64, j-2);
            }
            /* *** */
...
qboolean CTFPickup_Tech (edict_t *ent, edict_t *other)
{
    ...
    /* *** Don't interfere with fake death *** */
...
//  tech->nextthink = level.time + CTF_TECH_TIMEOUT;
//  tech->think = TechThink;
    tech->nextthink = level.time + 1;
    tech->think = tomtechfix;
...
void BrrrQ2Credits1(edict_t *ent, pmenu_t *p);
void BrrrQ2Credits2(edict_t *ent, pmenu_t *p);
...
pmenu_t creditsmenu[] = {
    { "*Annihilation Quake II with",    PMENU_ALIGN_CENTER, NULL, NULL },
...
pmenu_t brrrq2creditsmenu1[] = {
    { "*Annihilation Quake II with",    PMENU_ALIGN_CENTER, NULL, NULL },
    { "*ThreeWave Capture the Flag",    PMENU_ALIGN_CENTER, NULL, NULL },
    { NULL,                             PMENU_ALIGN_CENTER, NULL, NULL },
    { "*Programming / Project Manager", PMENU_ALIGN_CENTER, NULL, NULL },
    { "Tom McIntyre - eLiTe",           PMENU_ALIGN_CENTER, NULL, NULL },
	{ NULL,                             PMENU_ALIGN_CENTER, NULL, NULL },
    { "*Modelling",                     PMENU_ALIGN_CENTER, NULL, NULL },
    { "Dave Walmsley - obi-1",          PMENU_ALIGN_CENTER, NULL, NULL },
    { "Tom McIntyre - eLiTe",           PMENU_ALIGN_CENTER, NULL, NULL },
	{ NULL,                             PMENU_ALIGN_CENTER, NULL, NULL },
    { "*Mapping",                       PMENU_ALIGN_CENTER, NULL, NULL },
	{ "Tim Bourne - Lord Imric",        PMENU_ALIGN_CENTER, NULL, NULL },
	{ "Nick Robinson - FOX HQ",         PMENU_ALIGN_CENTER, NULL, NULL },
	{ "FragAngeL [RETIRED]",            PMENU_ALIGN_CENTER, NULL, NULL },
	{ "hitsuji [GREETZ]",               PMENU_ALIGN_CENTER, NULL, NULL },
	{ NULL,                             PMENU_ALIGN_CENTER, NULL, NULL },
	{ "Continue...",                    PMENU_ALIGN_LEFT, NULL, BrrrQ2Credits2 },
	{ "Return to Main Menu",            PMENU_ALIGN_LEFT, NULL, CTFReturnToMain }
};

pmenu_t brrrq2creditsmenu2[] = {
	{ "*Annihilation Quake II with",    PMENU_ALIGN_CENTER, NULL, NULL },
	{ "*ThreeWave Capture the Flag",    PMENU_ALIGN_CENTER, NULL, NULL },
	{ NULL,                             PMENU_ALIGN_CENTER, NULL, NULL },
    { "*Skinning",                      PMENU_ALIGN_CENTER, NULL, NULL },
    { "Tom McIntyre - eLiTe",           PMENU_ALIGN_CENTER, NULL, NULL },
    { "Dave Walmsley - obi-1",          PMENU_ALIGN_CENTER, NULL, NULL },
	{ NULL,                             PMENU_ALIGN_CENTER, NULL, NULL },
	{ "*Scripting/Documentation/News",  PMENU_ALIGN_CENTER, NULL, NULL },
	{ "Tom McIntyre - eLiTe",           PMENU_ALIGN_CENTER, NULL, NULL },
	{ NULL,                             PMENU_ALIGN_CENTER, NULL, NULL },
	{ "*Web Designer / Admin",          PMENU_ALIGN_CENTER, NULL, NULL },
	{ "Recoil of Radiation Designs",    PMENU_ALIGN_CENTER, NULL, NULL },
	{ NULL,                             PMENU_ALIGN_CENTER, NULL, NULL },
	{ "*Extra Item Placement",          PMENU_ALIGN_CENTER, NULL, NULL },
	{ "Richard Grant - Game Guru",      PMENU_ALIGN_CENTER, NULL, NULL },
	{ NULL,                             PMENU_ALIGN_CENTER, NULL, NULL },
	{ NULL,                             PMENU_ALIGN_CENTER, NULL, NULL },
	{ "Return to Main Menu",            PMENU_ALIGN_LEFT, NULL, CTFReturnToMain }
};
...
pmenu_t joinmenu[] = {
	...
	{ "Annihilation Credits",           PMENU_ALIGN_LEFT, NULL, BrrrQ2Credits1 },
	{ "CTF Credits",        PMENU_ALIGN_LEFT, NULL, CTFCredits },
	{ NULL,                 PMENU_ALIGN_LEFT, NULL, NULL },
	...
	{ NULL,                 PMENU_ALIGN_LEFT, NULL, NULL },
	{ "V" BRRR_VERSION,     PMENU_ALIGN_RIGHT, NULL, NULL },
};
...
{
    PMenu_Close(ent);
    PMenu_Open(ent, brrrq2creditsmenu1, -1, sizeof(brrrq2creditsmenu1) / sizeof(pmenu_t));
}

void BrrrQ2Credits2(edict_t *ent, pmenu_t *p)
{
    PMenu_Close(ent);
    PMenu_Open(ent, brrrq2creditsmenu2, -1, sizeof(brrrq2creditsmenu2) / sizeof(pmenu_t));
}
...
/* *** TOM: Allows techs to be picked up again by dropper *** */
void tomtechfix(edict_t *tech)
{
    tech->nextthink = level.time + CTF_TECH_TIMEOUT;
    tech->think = TechThink;
