...
//#if 0 // remove monster code // Not any more - Tom
...
//#if 0 // remove monster code /* *** TOM: Not any more :)
...
/* *** ANN TURRET *** */
#if 0
	{"annturret_body", SP_annturret_body},
#endif
/* *** */
	{NULL, NULL}
};
...
/* *** BRRR STATUSBAR *** */
/* These have been moved into C_BRRR.C */
...
/* *** BRRR STATUSBAR - Handled in G_BRRR.C *** ...
	// status bar program
	if (deathmatch->value)
//ZOID
		if (ctf->value) {
...
... *** */
	...
	/* TOM: Added weapon models *** */
	gi.modelindex( "#w_pipebomb.md2");
	gi.modelindex( "#w_proximity.md2");
	gi.modelindex( "#w_saber.md2");
	gi.modelindex( "#w_disruptor.md2");
	gi.modelindex( "#w_sniper.md2");
	gi.modelindex( "#w_phaser.md2");
	gi.modelindex( "#w_freezethrower.md2");
	/* *** */
	/* *** */
