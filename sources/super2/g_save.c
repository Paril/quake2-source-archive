...
// SH CTF
	...
	ctf_force = gi.cvar ("ctf_force", "0", CVAR_SERVERINFO);
	hunt = gi.cvar("hunt", "0", CVAR_SERVERINFO);
	playerlock = gi.cvar("playerlock", "0", CVAR_SERVERINFO);
	queue = gi.cvar("queue", "0", CVAR_SERVERINFO);
// SH CTF
...
// SH
	...
	{
// work around for reconnect w/o disconnect
