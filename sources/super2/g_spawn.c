...
"if 22 "                        // New. If STAT_TEAM1_FLAG is not zero, then do
"       xl      2 "            // New
"       yb      -126 "           // New
"       num     3       23 "    // New. Display 2-digits with value from stat-array at index 23
"       yb      -102 "            // New
...
"if 24 "                        // New. If STAT_TEAM2_FLAG is not zero, then do
"       xl      2 "          // New
"       yb      -78 "            // New
"       num     3       25 "    // New. Display 2-digits with value from stat-array at index 24
"       yb      -54 "            // New
...
// special power icon
"if 20 "                        // New. If STAT_SPECIAL_ICON is not zero, then do
"       yb      -78 "           // New
"       xr      -58 "           // New
...
// passive power icon
"if 18 "                        // New. If STAT_PASSIVE_ICON is not zero, then do
"       yb      -102 "           // New
"       xr      -58 "           // New
...
// active power icon                       // New
"if 16 "                        // New. If STAT_ACTIVE_ICON is not zero, then do
"       yb      -126 "           // New
"       xr      -58 "           // New
...
// SH
	invis_index = gi.modelindex ("models/super2/invis/tris.md2");
	cripple_index = gi.modelindex ("models/cripple/tris.md2");
	robot_index = gi.modelindex ("models/robot/tris.md2");
...
int hunt_precache ()
{
	gi.soundindex ("gladiator/pain.wav");	
	gi.soundindex ("gladiator/gldpain2.wav");	
	...
	gi.soundindex ("soldier/soldeth1.wav");
	gi.soundindex ("soldier/solatck1.wav");
	gi.soundindex ("soldier/solpain2.wav");
	gi.soundindex ("soldier/soldeth2.wav");
	...
	gi.soundindex ("infantry/infatck3.wav");
	gi.soundindex ("soldier/solpain3.wav");
	gi.soundindex ("soldier/soldeth3.wav");
	gi.soundindex ("soldier/solatck3.wav");

	gi.soundindex ("infantry/infpain1.wav");
	gi.soundindex ("infantry/infpain2.wav");
	gi.soundindex ("infantry/infdeth1.wav");
	gi.soundindex ("infantry/infdeth2.wav");
	gi.soundindex ("infantry/infatck1.wav");
	gi.soundindex ("infantry/infatck3.wav");
	gi.soundindex ("infantry/infatck2.wav");
	gi.soundindex ("infantry/melee2.wav");
	gi.soundindex ("infantry/infsght1.wav");
	gi.soundindex ("infantry/infsrch1.wav");
	gi.soundindex ("infantry/infidle1.wav");
	...
	gi.soundindex ("mutant/mutpain2.wav");
	gi.soundindex ("mutant/mutsght1.wav");
	gi.soundindex ("mutant/mutsrch1.wav");
	...
	gi.soundindex ("floater/fltatck2.wav");
	gi.soundindex ("floater/fltatck3.wav");
	gi.soundindex ("floater/fltdeth1.wav");
	gi.soundindex ("floater/fltidle1.wav");
	gi.soundindex ("floater/fltpain1.wav");
	gi.soundindex ("floater/fltpain2.wav");
	gi.soundindex ("floater/fltsght1.wav");
