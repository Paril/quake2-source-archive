...
# ADD LINK32 kernel32.lib user32.lib winmm.lib /nologo /subsystem:windows /dll /machine:I386 /out:".\gamex86.dll" /libpath:"win32\lib"
...
# ADD LINK32 kernel32.lib user32.lib winmm.lib /nologo /subsystem:windows /dll /incremental:no /map /debug /machine:I386 /out:".\gamex86.dll" /pdbtype:sept /libpath:"win32\lib"
