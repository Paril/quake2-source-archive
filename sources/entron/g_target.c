...
void target_explosion_quietexplode (edict_t *self)
{
   float k = random();
   float save;
   edict_t *ent;
...
void use_target_explosion (edict_t *self, edict_t *other, edict_t *activator)
{
	...
	if (!self->delay)
      ...
      if (self->style)
         ...
         target_explosion_quietexplode(self);
		return;
	   }
   ...
   if (self->style)
      ...
      {
	   self->think = target_explosion_quietexplode;
	   self->nextthink = level.time + self->delay;
      }
}
...
void use_target_splash (edict_t *self, edict_t *other, edict_t *activator)
{
	...
	else
	{
		...
		gi.multicast (self->s.origin, MULTICAST_PVS);
		if(self->sounds == 7)
			gi.sound (self, CHAN_VOICE, gi.soundindex("world/zap01.wav"), 1, ATTN_NORM, 0);
		else if(self->sounds == 8)
			gi.sound (self, CHAN_VOICE, gi.soundindex("world/zap02.wav"), 1, ATTN_NORM, 0);
	}
