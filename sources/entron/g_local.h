...
typedef struct
{
   ...
   float          nextcover;
   float          nextambush;
   void		      (*action[16]) (edict_t *self);
	void		      (*reload)(edict_t *self);
   void		      (*decap) (edict_t *self, int damage);
   map_node_t     *goalnode;
   ambush_node_t  *goalambush;
   map_node_t     *lastnode;
	vec3_t	      goalvector;
   edict_t        *chaser;
   mmove_t        *save;
...
// CCH
extern	cvar_t	*beh_items;
extern	cvar_t	*allow_grapple;
extern	cvar_t	*allow_tech;
