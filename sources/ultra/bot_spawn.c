...
// AJ force to best weapon
		...
		&& (start_weapon->value==0 || start_weapon->value==10))
	{
		...
		&& (start_weapon->value==0 || start_weapon->value==9))
	{
		...
		&&  client->pers.inventory[ITEM_INDEX(item_cells)]
		&& (start_weapon->value==0 || start_weapon->value==8))
	{
		...
		&& (start_weapon->value==0 || start_weapon->value==7))
	{
		...
		&& (start_weapon->value==0 || start_weapon->value==6))
	{
		...
		&& (start_weapon->value==0 || start_weapon->value==5))
	{
		...
		&&  client->pers.inventory[ITEM_INDEX(item_bullets)] 
		&& (start_weapon->value==0 || start_weapon->value==4))
	{
		...
		&& (start_weapon->value==0 || start_weapon->value==3))
	{
		...
		&&  client->pers.inventory[ITEM_INDEX(item_shells)] 
		&& (start_weapon->value==0 || start_weapon->value==2))
	{
		...
		&& (start_weapon->value==0 || start_weapon->value==1))
	{
