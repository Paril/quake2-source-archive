...
edict_t	*plat_ent = NULL, *start_trail;	// used for node laying
...
void Touch_Plat_Center (edict_t *ent, edict_t *other, cplane_t *plane, csurface_t *surf)
{
	...
	// ERASER hack, don't go up if the bot doesn't specifically want to
	...
	ent->movetarget = other;	// NODES: tell the plat who is riding it
...
void button_touch (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf)
{
	...
	// nodes, drop a node here if not touched yet
	if (self->frags < 1)
	{
		self->frags = 1;
