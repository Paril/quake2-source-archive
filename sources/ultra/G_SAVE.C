...
//ZOID
	...
	hook_homing_radius = gi.cvar ("hook_homing_radius", "200", CVAR_SERVERINFO);
	hook_homing_factor = gi.cvar ("hook_homing_factor", "5", CVAR_SERVERINFO);
	hook_players       = gi.cvar ("hook_players", "1", CVAR_SERVERINFO);
//	hook_sky           = gi.cvar ("hook_sky", "1", CVAR_SERVERINFO);
	hook_min_length    = gi.cvar ("hook_min_length", "20", CVAR_SERVERINFO);
	hook_max_length    = gi.cvar ("hook_max_length", "2000", CVAR_SERVERINFO);
	hook_pull_speed    = gi.cvar ("hook_pull_speed", "80", CVAR_SERVERINFO);
	hook_fire_speed    = gi.cvar ("hook_fire_speed", "2000", CVAR_SERVERINFO);
	hook_messages      = gi.cvar ("hook_messages", "1", CVAR_SERVERINFO);
	hook_vampirism     = gi.cvar ("hook_vampirism", "0", CVAR_SERVERINFO);
	hook_vampire_ratio = gi.cvar ("hook_vampire_ratio", "0.5", CVAR_SERVERINFO);
	// end AJ
