...
void Cmd_Stats_f (edict_t *self)
{
        ...
        if (ent->client->resp.team == TEAM_ALIEN || (!ent->client->resp.team && ent->client->resp.old_team == TEAM_ALIEN))  {
                ...
                gi.cprintf (self, PRINT_HIGH, "%s:\n+----+----+----+----+----+----+----+----+----+----+-----+----+-------+\n|Engi|Grnt| ST |Bio | HT |Cmdo|Ext |Mech|Tele|Feed| Bal | TK |Counter|\n+----+----+----+----+----+----+----+----+----+----+-----+----+-------+\n|%-4d|%-4d|%-4d|%-4d|%-4d|%-4d|%-4d|%-4d|%-4d|%-4d|%-+5d|%-4d|%-7d|\n+----+----+----+----+----+----+----+----+----+----+-----+----+-------+\n", ent->client->pers.netname, ent->client->resp.kills[CLASS_ENGINEER], ent->client->resp.kills[CLASS_GRUNT], ent->client->resp.kills[CLASS_SHOCK], ent->client->resp.kills[CLASS_BIO], ent->client->resp.kills[CLASS_HEAVY], ent->client->resp.kills[CLASS_COMMANDO], ent->client->resp.kills[CLASS_EXTERM], ent->client->resp.kills[CLASS_MECH], ent->client->resp.kills[SPAWNKILLS], ent->client->resp.kills[PLAYERDEATHS], balance, tks, ent->client->resp.teamkills);
                ...
                gi.cprintf (self, PRINT_HIGH, "%s:\n+----+----+----+----+----+----+----+----+----+----+-----+----+-------+\n|Brdr|Hatc|Dron|Wrth|Kami|Stng|Guar|Stlk|Egg |Feed| Bal | TK |Counter|\n+----+----+----+----+----+----+----+----+----+----+-----+----+-------+\n|%-4d|%-4d|%-4d|%-4d|%-4d|%-4d|%-4d|%-4d|%-4d|%-4d|%-+5d|%-4d|%-7d|\n+----+----+----+----+----+----+----+----+----+----+-----+----+-------+\n", ent->client->pers.netname, ent->client->resp.kills[CLASS_BREEDER], ent->client->resp.kills[CLASS_HATCHLING], ent->client->resp.kills[CLASS_DRONE], ent->client->resp.kills[CLASS_WRAITH], ent->client->resp.kills[CLASS_KAMIKAZE], ent->client->resp.kills[CLASS_STINGER], ent->client->resp.kills[CLASS_GUARDIAN], ent->client->resp.kills[CLASS_STALKER], ent->client->resp.kills[SPAWNKILLS], ent->client->resp.kills[PLAYERDEATHS], balance, tks, ent->client->resp.teamkills);
        } else {
