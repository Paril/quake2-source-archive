...
static void Killed (edict_t *targ, edict_t *inflictor, edict_t *attacker, int damage, vec3_t point)
{
  ...
  if (targ->client && !attacker->client) {
    ...
    if (r->pushfraction > 0 && r->pusher->inuse) { //Pushed into something?
      ...
      VectorSubtract(point, r->pushpoint, dir); dir[2] = 0;
...
static dmgscale_t corrode_class[1+NUMCLASSES+1] = {
  /*ALL                 */ {0,        0, 0.5f,  0.5f},
  /*CLASS_GRUNT		*/ {0,        0, 0.75f, 0.75f},
  /*CLASS_HATCHLING	*/ {0,        0, 1.0f,  1.0f},
  /*CLASS_HEAVY		*/ {DS_REDIR, CLASS_GRUNT},
  /*CLASS_COMMANDO	*/ {DS_REDIR, CLASS_GRUNT},
  /*CLASS_DRONE		*/ {DS_REDIR, CLASS_HATCHLING},
  /*CLASS_MECH		*/ {0,        0, 0.0f,  0.0f},
  /*CLASS_SHOCK		*/ {0,        0, 0.63f, 0.7f},
  /*CLASS_STALKER	*/ {0,        0, 0.5f,  0.5f},
  /*CLASS_BREEDER	*/ {DS_REDIR, CLASS_HATCHLING},
  /*CLASS_ENGINEER	*/ {0,        0, 0.33f, 0.33f},
  /*CLASS_GUARDIAN	*/ {DS_REDIR, CLASS_STALKER},
  /*CLASS_KAMIKAZE	*/ {DS_REDIR, CLASS_HATCHLING},
  /*CLASS_EXTERM	*/ {0,        0, 0.8f,  0.1f},
  /*CLASS_STINGER	*/ {DS_REDIR, CLASS_STALKER},
  /*CLASS_WRAITH	*/ {DS_REDIR, CLASS_HATCHLING},
  /*CLASS_BIO		*/ {DS_REDIR, CLASS_GRUNT},
  /*CLASS_OBSERVER	*/ {0}
};
...
static dmgscale_t corrode_entity[1+ENT_COUNT+1] = {
  /*ALL                 */ {0,        0, 1.00f},
  /*ENT_UNKNOWN		*/ {0,        0, 1.00f},
  /*ENT_DRONEWEB	*/ {0,        0, 1.00f},
  /*ENT_SPIKE		*/ {0,        0, 1.00f},
  /*ENT_TURRET		*/ {0,        0, 0.33f},
  /*ENT_MGTURRET	*/ {0,        0, 0.33f},
  /*ENT_TURRETBASE	*/ {0,        0, 0.33f},
  /*ENT_DETECTOR	*/ {0,        0, 0.25f},
  /*ENT_TRIPWIRE_BOMB	*/ {0,        0, 1.33f},
  /*ENT_TRIPWIRE_LASER	*/ {0,        0, 1.00f},
  /*ENT_AMMO_DEPOT	*/ {0,        0, 0.33f},
  /*ENT_TELEPORTER_U	*/ {0,        0, 0.33f},
  /*ENT_TELEPORTER_D	*/ {0,        0, 0.33f},
  /*ENT_TELEPORTER	*/ {0,        0, 0.33f},
  /*ENT_COCOON_U	*/ {0,        0, 1.00f},
  /*ENT_COCOON_D	*/ {0,        0, 1.00f},
  /*ENT_COCOON		*/ {0,        0, 1.00f},
  /*ENT_SPIKER		*/ {0,        0, 1.50f},
  /*ENT_OBSTACLE	*/ {0,        0, 2.00f},
  /*ENT_GASSER		*/ {0,        0, 1.50f},
  /*ENT_HEALER		*/ {0,        0, 1.00f},
  /*ENT_WRAITHBOMB	*/ {0,        0, 1.00f},
  /*ENT_ROCKET		*/ {0,        0, 1.00f},
  /*ENT_GRENADE		*/ {0,        0, 1.00f},
  /*ENT_FLASH_GRENADE	*/ {0,        0, 1.00f},
  /*ENT_SMOKE_GRENADE	*/ {0,        0, 1.00f},
  /*ENT_C4		*/ {0,        0, 1.00f},
  /*ENT_GAS_SPORE	*/ {0,        0, 1.00f},
  /*ENT_SPIKE_SPORE	*/ {0,        0, 1.00f},
  /*ENT_PROXY_SPORE	*/ {0,        0, 1.00f},
  /*ENT_FLARE		*/ {0,        0, 1.00f},
  /*ENT_INFEST		*/ {0,        0, 0.25f},
  /*ENT_CORPSE		*/ {0,        0, 0.25f},
  /*ENT_HUMAN_BODY	*/ {0,        0, 0.25f},
  /*ENT_FEMALE_BODY	*/ {0,        0, 0.25f},
  /*ENT_FLAMES		*/ {0,        0, 1.00f},
  /*ENT_GASSER_GAS	*/ {0,        0, 1.00f},
  /*ENT_BLASTER		*/ {0,        0, 1.00f},
  /*ENT_NOBLOOD_BODY	*/ {0,        0, 1.00f},
  /*ENT_AREAPORTAL	*/ {0,        0, 1.00f},
  /*ENT_FUNC_DOOR	*/ {0,        0, 1.00f},
  /*ENT_TARGET_BLASTER	*/ {0,        0, 1.00f},
  /*ENT_PROXYSPIKE	*/ {0,        0, 1.00f},
  /*ENT_FUNC_EXPLOSIVE	*/ {0,        0, 1.00f},
  /*ENT_FUNC_WALL	*/ {0,        0, 1.00f},
  /*ENT_EVIL_HEALER	*/ {0,        0, 1.00f},
  /*ENT_GRENADE_NEW	*/ {0,        0, 1.00f},
  /*ENT_GRENADE		*/ {0,        0, 1.00f},
  /*ENT_TURRET_BLOB	*/ {0,        0, 1.00f},
  /*ENT_FAKE		*/ {0,        0, 1.00f},
  /*ENT_SD_CAUSER	*/ {0,        0, 1.00f}
};
  ...
  if (overriden) {
	  ...
	  if (attacker->client && (attacker->client->resp.class_type == CLASS_HATCHLING || attacker->client->resp.class_type ==
          ...
          if (!(client->ps.pmove.pm_flags & PMF_DUCKED)) {
            ...
            take *= (dmg.lstorso+dmg.lslegs)*0.5f;
          }
        } //human locations
      } // locations
        ...
        if (take)
        {
                ...
                if (targ->health <= 0) {
                  ...
                  if (targ->client && targ->health < 0 && !wasdead && mod != MOD_TELEFRAG && mod != MOD_FALLING) {  //split damage in 2 so damage vs corpses uses proper scaling and gib flags
                    ...
                    if (targ->die) Killed(targ, inflictor, attacker, damage, point); //kill player
