...
//WF34 -support for lmctf
void SP_info_position (edict_t *self);
void SP_item_flagreturn (edict_t *self);
//WF34
void SP_rotating_light (edict_t *self);//Acrid lightcode 1/29/99
...
//WF34
	...
	{"rotating_light", SP_rotating_light},//Acrid lightcode 1/29/99
...
void ED_ParseField (char *key, char *value, edict_t *ent)
{
	...
	{
		if (!(f->flags & FFL_NOSPAWN) && !Q_stricmp(f->name, key))//WF34 F->F & FFL
		{	// found it
...
// parse ents
	...
	PlayerTrail_Init ();//ACRID MOVED WF34
...
//ERASER END
	...
	level.pic_damage = gi.imageindex ("damage");
	level.pic_timeout = gi.imageindex ("timeout");
	gi.imageindex ("help");
...
//WF24 S
	...
	gi.modelindex ("models/dart/tris.md2");//WF34 S
	...
	gi.modelindex ("models/objects/turretg/tris.md2");//WF34 E

//ERASER START FIXME ACRID DUEL VIEWWEP????
	// 3.15+ VWeap support
/*	gi.modelindex( "#w_blaster.md2");	gi.modelindex( "#w_shotgun.md2");
	gi.modelindex( "#w_sshotgun.md2");	gi.modelindex( "#w_machinegun.md2");
	gi.modelindex( "#w_chaingun.md2");	gi.modelindex( "#a_grenades.md2");
	gi.modelindex( "#w_glauncher.md2");	gi.modelindex( "#w_rlauncher.md2");
	gi.modelindex( "#w_hyperblaster.md2");	gi.modelindex( "#w_railgun.md2");
	gi.modelindex( "#w_bfg.md2");		gi.modelindex( "#w_grapple.md2");
*/
	//ERASER END ACRID CO
//WF34 Sounds
	gi.soundindex ("cdecoyof.wav");
	gi.soundindex ("cdecoyon.wav");
	gi.soundindex ("fdecoyof.wav");
	gi.soundindex ("fdecoyon.wav");
	gi.soundindex ("mdecoyof.wav");
	gi.soundindex ("mdecoyon.wav");
	gi.soundindex ("ctf/flagcap.wav");
	gi.soundindex ("ctf/tech4.wav");
	gi.soundindex ("darthit.wav");
	gi.soundindex ("electric.wav");
	gi.soundindex ("homelock.wav");
	gi.soundindex ("jetfly.wav");
	gi.soundindex ("jumppack.wav");
	...
	gi.soundindex ("weapons/knifescream.wav");
	gi.soundindex ("weapons/knifeswish.wav");
...
//	gi.imageindex (PIC_LEFT);
//	gi.imageindex (PIC_RIGHT);
