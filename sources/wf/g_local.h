...
#define	GAMEVERSION	"WeaponsFactory"
...
#define FL_SHOWPATH				0x00020000      // used to show current path (debugging)
#define FL_SHOW_FLAGPATHS		0x00040000  //WF DIF FL_BOOTS

//OTHER
#define FL_BOOTS				0x00080000  //Anti-Gravity boots flag
...
static vec3_t VEC_ORIGIN = {0,0,0};//WF24
...
MOVETYPE_BOUNCE,
//WF
MOVETYPE_FLYRICOCHET,	// For bouncing blaster
MOVETYPE_FLOAT          // No gravity, but slows down and stops in mid air
//WF
...
typedef struct
{
	...
	int			pic_damage;			// icon for weapon damage
	int			pic_timeout;		// icon for timeout called by ref
} level_locals_t;
...
//WF - Weapons Factory means of death
#define MOD_WF_LASERBALL		35
#define MOD_WF_GOODYEAR			36
#define MOD_WF_PROXIMITY		37
#define MOD_WF_CLUSTER			38
#define MOD_WF_PIPEBOMB			39
#define MOD_WF_EARTHQUAKE		40
#define MOD_REVERSE_TELEFRAG	41
#define MOD_WF_TURRET			42
#define MOD_WF_FLAME			43
#define MOD_NAG					44
#define MOD_MBPC				45
#define MOD_SHRAPNEL			46
#define MOD_CLUSTERROCKET		47
#define MOD_PLASMABOMB			48
#define MOD_DISEASE				49
#define MOD_SNIPERRIFLE			50
#define MOD_NAIL				51
#define MOD_SHC					52
#define MOD_NEEDLER				53
#define MOD_CONCUSSION			54
#define MOD_ARMORDART			55
#define MOD_INFECTEDDART		56
#define MOD_NAPALMROCKET		57
#define MOD_LIGHTNING			58
#define MOD_TELSA				59
#define MOD_MAGNOTRON			60
#define MOD_SHOCK				61
#define MOD_PELLET				62
#define MOD_FLAREGUN			64
#define MOD_TRANQUILIZER		65
#define MOD_BOLTEDBLASTER		66
#define MOD_SENTRY				67
#define MOD_LRPROJECTILE		68
#define MOD_FLARE				69
#define MOD_KAMIKAZE			70
#define MOD_DEPOT				71
#define MOD_SENTRYKILLER		72
#define MOD_MEGACHAINGUN		73
#define MOD_HOMINGROCKET		74
#define MOD_TRANQUILIZERDART	75
#define MOD_SNIPERRIFLE_LEG		76
#define MOD_SNIPERRIFLE_HEAD	77
#define MOD_SENTRY_ROCKET		78
#define MOD_KNIFE				79
#define MOD_KNIFEBACK			80
#define MOD_HEALINGDEPOT		81
#define MOD_LASERCUTTER			82
#define MOD_NAPALMGRENADE		83
#define MOD_FLAMETHROWER		84
#define MOD_BIOSENTRY			85
#define MOD_AK47				86
#define MOD_PISTOL				87

//XATRIX and ROGUE
#define MOD_RIPPER				88
#define MOD_PHALANX				89
#define MOD_ETF_RIFLE			90
#define MOD_TESLA				91
#define MOD_HEATBEAM			92
#define MOD_DEFENDER_SPHERE		93
#define MOD_BLASTER2			94
#define MOD_TRACKER				95
#define MOD_NUKE				96

//More WF
#define MOD_LASER_DEFENSE		97
#define MOD_GASGRENADE			98
#define MOD_STINGER				99
#define MOD_MISSILE				100
#define MOD_CAMERA				101
#define MOD_FEIGN				102
#define MOD_FREEZER             103 //acrid 3/99
#define MOD_DEPOT_EXPLODE		104	// depot destroyed by someone other then owner
...
//WF
extern	cvar_t	*wfflags;
extern	cvar_t  *wfconfig;
//extern	cvar_t  *classdef;
extern	cvar_t	*gamedir;
extern	cvar_t	*mock;
extern	cvar_t	*mod;
//extern  cvar_t  *unbalanced_limit;
extern  cvar_t  *filterban;	//1=(default) don't allow anyone on list
							//0= only allow those on list
//extern	cvar_t	*noclass;	//bit mask to turn off classes

//extern	cvar_t	*banweapon;
//extern	cvar_t	*bangrenade;
//extern	cvar_t	*banspecial;
//extern	cvar_t	*logfilename;

extern	int		wfdebug;	//special messages if turned on
extern	int		flag1dropped;	//flags to determine if flag was dropped
extern	int		flag2dropped;
//WF

extern	cvar_t	*needpass;
extern	cvar_t	*sv_maplist;

extern  cvar_t  *wfpassword;
...
struct edict_s
{
	...
	// freezer code
	//WF ACRID3
//WF MOVED ALL THIS BELOW FOR TESTING
//ERASER START
	...
	qboolean	bot_client;
//ACO	struct gclient_s	*bot_client;		// stores client relevant data for bots, like weapon ammo, health, etc//WAS ALREADY CO
...
gitem_t	*item_shotgun, *item_hyperblaster, *item_supershotgun, *item_grenadelauncher, 
    *item_chaingun, *item_railgun, *item_machinegun, *item_bfg10k, *item_rocketlauncher, 
	*item_blaster, *item_sniperrifle, *item_lightninggun, *item_infecteddart, 
	*item_pulsecannon, *item_telsacoil, *item_flamethrower, *item_needler , 
	*item_pelletrocketlauncher, *item_rocketnapalmlauncher ,*item_rocketclusterlauncher, 
	*item_shc, *item_handgrenades, *item_poisondart, *item_ak47, *item_pistol,
	*item_sentryspot, *item_depotspot, *item_armordart, *item_stingerrocketlauncher, *item_knife;
