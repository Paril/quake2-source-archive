...
void ChickSlash (edict_t *self)
{
	...
	Vec3Set (aim, MELEE_DISTANCE, self->mins[0], 10);
...
void ChickRocket (edict_t *self)
{
	...
	G_ProjectSource (self->s.origin, dumb_and_hacky_monster_MuzzFlashOffset[MZ2_CHICK_ROCKET_1], forward, right, start);
