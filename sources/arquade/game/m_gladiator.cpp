...
void GaldiatorMelee (edict_t *self)
{
	...
	Vec3Set (aim, MELEE_DISTANCE, self->mins[0], -4);
...
void GladiatorGun (edict_t *self)
{
	...
	G_ProjectSource (self->s.origin, dumb_and_hacky_monster_MuzzFlashOffset[MZ2_GLADIATOR_RAILGUN_1], forward, right, start);
