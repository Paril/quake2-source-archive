...
void jorgBFG (edict_t *self)
{
	...
	G_ProjectSource (self->s.origin, dumb_and_hacky_monster_MuzzFlashOffset[MZ2_JORG_BFG_1], forward, right, start);
...
void jorg_firebullet_right (edict_t *self)
{
	...
	Angles_Vectors (self->s.angles, forward, right, NULL);
	G_ProjectSource (self->s.origin, dumb_and_hacky_monster_MuzzFlashOffset[MZ2_JORG_MACHINEGUN_R1], forward, right, start);
...
void jorg_firebullet_left (edict_t *self)
{
	...
	Angles_Vectors (self->s.angles, forward, right, NULL);
	G_ProjectSource (self->s.origin, dumb_and_hacky_monster_MuzzFlashOffset[MZ2_JORG_MACHINEGUN_L1], forward, right, start);
...
void SP_monster_jorg (edict_t *self)
{
	...
	Vec3Set (self->mins, -80, -80, 0);
	Vec3Set (self->maxs, 80, 80, 140);
