...
void parasite_drain_attack (edict_t *self)
{
	...
	Vec3Subtract (start, end, dir);
	T_Damage (self->enemy, self, self, dir, self->enemy->s.origin, vec3Origin, damage, 0, DAMAGE_NO_KNOCKBACK, MOD_UNKNOWN);
}
