...
{
	if (ent->velocity[0] < -900)
		ent->velocity[0] = -900;
	else if (ent->velocity[0] > 900)
		ent->velocity[0] = 900;
	if (ent->velocity[1] < -900)
		ent->velocity[1] = -900;
	else if (ent->velocity[1] > 900)
		ent->velocity[1] = 900;
	if (ent->velocity[2] < 600)
		ent->velocity[2] = 600;	// always some upwards
	else if (ent->velocity[2] > 1500)
		ent->velocity[2] = 1500;
}
...
void ThrowGib (edict_t *self, char *gibname, int damage, int type)
{
	...
	ClipGibVelocity (gib);
	gib->avelocity[0] = random()*1200;
	gib->avelocity[1] = random()*1200;
	gib->avelocity[2] = random()*1200;

	gib->think = G_FreeEdict;
	gib->nextthink = level.time + 1 + random()*3;
