...
void InitGame (void)
{
	...
	//KOTS
	kots_password = gi.cvar ( "kots_password", "" , CVAR_USERINFO );
	kots_datapath	= gi.cvar ( "kots_datapath", "" , CVAR_LATCH );
	kots_realtime	= gi.cvar ( "kots_realtime", "0", CVAR_LATCH );
	kots_levelmin	= gi.cvar ( "kots_levelmin", "0", CVAR_SERVERINFO );
	kots_levelmax	= gi.cvar ( "kots_levelmax", "1000", CVAR_SERVERINFO );
	kots_teamplay	= gi.cvar ( "kots_teamplay", "0", CVAR_SERVERINFO );
	kots_skin1		= gi.cvar ( "kots_skin1"   , "male/howitzer", CVAR_LATCH );
	kots_skin2		= gi.cvar ( "kots_skin2"   , "female/brianna", CVAR_LATCH );
	kots_lives  	= gi.cvar ( "kots_lives"   , "0"  , CVAR_LATCH );
	kots_port		  = gi.cvar ( "port"         , "0"  , CVAR_SERVERINFO );
	kots_game		  = gi.cvar ( "game"         , "0"  , CVAR_SERVERINFO );
	kots_version  = gi.cvar ( "kots_version" , KOTS_VERSION, CVAR_SERVERINFO );

	if ( kots_lives->value )
		maxspectators = gi.cvar ("maxclients", "4", CVAR_SERVERINFO | CVAR_LATCH);
