...
// SCONFIG START
#define STAT_TIMELEFT           16
#define STAT_CTF_ID_VIEW		17

#define STAT_RANK				18
#define STAT_PLAYERS		    19
//#define STAT_POS		        20 // Depending on this value, layout of HUD is different
// SCONFIG STOP

// Version 2.6b5
#define STAT_HELPHUD           20 // In glide mode or Chase Cam mode, pop up instructions
#define STAT_CLOAKCELLS        21
#define STAT_NUMCLOAKCELLS     22
...
#define	CS_IMAGES			(CS_SOUNDS+MAX_SOUNDS) // 288 + 256 = 544
#define	CS_LIGHTS			(CS_IMAGES+MAX_IMAGES) // 544 + 256 = 800
#define	CS_ITEMS			(CS_LIGHTS+MAX_LIGHTSTYLES) // 800 + 256 = 1056
#define	CS_PLAYERSKINS		(CS_ITEMS+MAX_ITEMS) // 1056 + 256 = 1312
#define	MAX_CONFIGSTRINGS	(CS_PLAYERSKINS+MAX_CLIENTS) // 1312 + 256 = 1568 
// Version 3.0
#define	NICENAME			1824  // 1568 + 256 = 1824
//#define	MAX_CONFIGSTRINGS	(NICENAME+MAX_CLIENTS) // 1312 + 256 = 1568 
