...
void ClientEndServerFrame (edict_t *ent)
{
	...
	// chase cam stuff
	// GRIM 10/10/2001 2:47PM - NEW COOP CAM
	...
	// GRIM 10/10/2001 1:16PM - become solid if possible
	if ((ent->svflags & SVF_DEADMONSTER) && (!ent->deadflag) && (ent->movetype != MOVETYPE_NOCLIP) && (level.framenum & 8) && (!CheckBox (ent)))
