...
int BerserkDMGAdjust(edict_t *ent, vec3_t point, vec3_t normal, int damage, int dflags, int mod)
{
	int save = 0;

	if ((dflags & DAMAGE_BULLET) && (ent->last_hitloc & LOCATION_ARMS))
...
//	self->monsterinfo.dodge = NULL;
	...
	// GRIM 8/10/2001 9:42PM
	self->dmgadjust = BerserkDMGAdjust;
	// GRIM
