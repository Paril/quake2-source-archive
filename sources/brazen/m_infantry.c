...
void infantry_touch (edict_t *ent, edict_t *other, cplane_t *plane, csurface_t *surf)
{
	...
	if (ent->s.frame == FRAME_death120)
		ent->s.frame = 0;
	else if (ent->s.frame == FRAME_death225)
		ent->s.frame = 1;
	else if (ent->s.frame == FRAME_death309)
		ent->s.frame = 2;
...
mframe_t infantry_frames_attack1 [] =
{
	...
	ai_charge, -1, infantry_fire_prep,//NULL,
	ai_charge, 1,  NULL,
	ai_charge, 1,  NULL,
	ai_charge, 2,  NULL,
	ai_charge, -2, NULL,
...
mframe_t infantry_frames_jump [] =
{
	...
	ai_move, -5, NULL,
	ai_move, 3,  NULL,
	ai_move, 4,  infantry_jump_now,
	ai_move, 0,  infantry_jump_wait_land
};

mmove_t infantry_move_jump = { FRAME_duck01, FRAME_duck05, infantry_frames_jump, infantry_run };
mmove_t infantry_move_jump2 = { FRAME_duck01, FRAME_jump05, infantry_frames_jump, infantry_run };
/*
mframe_t infantry_frames_jump [] =
{
	ai_move, 0, NULL,
