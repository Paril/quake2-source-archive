...
void hover_deadthink (edict_t *self)
{
	...
	StepShake(self->s.origin, 128, 50);
	// GRIM
...
// GRIM 27/10/2001 7:41PM
int HoverDMGAdjust(edict_t *ent, vec3_t point, vec3_t normal, int damage, int dflags, int mod)
{
	int save = 0;
...
//PGM
	...
	// GRIM 27/10/2001 7:31PM
	self->dmgadjust = HoverDMGAdjust;
