...
int GunnerDMGAdjust(edict_t *ent, vec3_t point, vec3_t normal, int damage, int dflags, int mod)
{
	...
	{	// bullet has landed on metal arms...  reduce damage done significantly
...
mmove_t gunner_move_jump2 = { FRAME_duck01, FRAME_duck08, gunner_frames_jump2, gunner_run };
/*
mframe_t gunner_frames_jump [] =
{
	ai_move, 0, NULL,
...
//	self->monsterinfo.dodge = gunner_dodge;
	...
	self->dmgadjust = GunnerDMGAdjust;
