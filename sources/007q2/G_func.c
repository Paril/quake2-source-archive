...
void SP_func_door (edict_t *ent)
{
	...
	if (ent->sounds == 5)
	{
		ent->moveinfo.sound_start = gi.soundindex  ("doors/fd_strt.wav");
		ent->moveinfo.sound_middle = gi.soundindex  ("doors/fd_mid.wav");
		ent->moveinfo.sound_end = gi.soundindex  ("doors/fd_end.wav");
	}
