...
#define	GAMEVERSION	"007q2"

// Colours thanks to Maj. Bitch
...
MOVETYPE_BOUNCE,
MOVETYPE_MINETOSS      // Proximity mine tossing
} movetype_t;
...
// Maj++ -----------------------------
#define IT_PACK       64 // New item flags
...
#define WEAP_PROXMINE           13
#define WEAP_REMOTE             14
#define WEAP_ZMG                15
#define WEAP_DUALZMG            16
#define WEAP_ASSRIFLE           17
#define WEAP_LASER              18
#define WEAP_RCP90              19
#define WEAP_D5K				20
*/
#define WEAP_BLASTER			1
//#define WEAP_SHOTGUN			2
...
#define WEAP_REMOTE             14
//#define WEAP_ZMG                15
#define WEAP_DUALZMG            15
#define WEAP_D5K				16
#define WEAP_KNIFE              17
...
#define MOD_PP7				35
#define MOD_HELDPROXMINE    36
#define MOD_PROXMINE		37
#define MOD_HP_SPLASH		38
#define MOD_P_SPLASH		39
#define MOD_REMOTE			40
//#define MOD_HP_SPLASH		41
#define MOD_LASER			41
#define MOD_AK47			42
#define MOD_ZMG				43
#define MOD_DUALZMG			44
#define MOD_AR33			45
#define MOD_RCP90			46
#define MOD_D5K 			47
#define MOD_HR_SPLASH		48
#define MOD_RP_SPLASH		49
#define MOD_SLAPPER			50
#define MOD_KNIFE			51
...
extern  cvar_t  *g_glass;
/*extern	cvar_t	*max_holes;
extern	edict_t		*firsthole;
extern	edict_t		*lasthole;
extern	int			holes;
*/extern  cvar_t  *lasercolour;
extern  cvar_t  *mp3music;
//extern  cvar_t  *cl_muzzle;
// ion
// ion extern  cvar_t  *weapontype
...
//ExtraMod: get the externalized Extra cvar_t's (line 2)
...
#define DEFAULT_PP7_HSPREAD 0
#define DEFAULT_PP7_VSPREAD 0
#define DEFAULT_KF7_HSPREAD 100
#define DEFAULT_KF7_VSPREAD 100
/*-=IoN_PuLse=-*/
...
//void fire_laser (edict_t *self, vec3_t start, vec3_t aimdir, int damage, int speed, int effect, qboolean hyper);
void fire_laser (edict_t *self, vec3_t start, vec3_t aimdir, int damage, int speed, int effect);
// end ion
//
// g_ptrail.c
//
...
//    int         zmg_shots;
	...
	qboolean	proxmine_blew_up;
    qboolean    remote_blew_up;
	float		grenade_time;
	float		proxmine_time;
    float       remote_time;
...
//Maj++ --------------------------------------
// NOTE: Good thing about client structs is that
// they get cleared and reset in PutClientInServer()
...
#include "bot.h" // Maj++ - add this header
//ZOID
//#include "g_ctf.h"
//ZOID
#include "g_teamdm.h"
