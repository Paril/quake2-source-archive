...
void CTFEffects(edict_t *player)
{
	...
	if (player->health > 0) {
		...
		if (player->client->pers.inventory[ITEM_INDEX(flag2_item)]) {
			player->s.effects |= 0x00004000;//EF_FLAG2;
		}
	}
...
void CTFWeapon_Grapple (edict_t *ent)
{
	...
	Weapon_Generic2 (ent, 5, 9, 31, 36, pause_frames, fire_frames, 
...
// debug
//gi.dprintf("It got as far as CTFJoinTeam.\n");
// debug
	...
	s = Info_ValueForKey (ent->client->pers.userinfo, "skin");
	CTFAssignSkin(ent, s);
//gi.dprintf("It got as far as CTFJoinTeam Assign Skin.\n");

	PutClientInServer (ent);
//gi.dprintf("It got as far as CTFJoinTeam Putinsever.\n");
...
{
//gi.dprintf("It got as far as CTFJoinTeam1.\n");
...
{
//gi.dprintf("It got as far as CTFJoinTeam2.\n");
...
//gi.dprintf("It got as far as CTFChaseCam.\n");
...
pmenu_t joinmenu[] = {
	{ "*Quake II",			PMENU_ALIGN_CENTER, NULL, NULL },
	{ "*007 Quake II Capture the Flag",	PMENU_ALIGN_CENTER, NULL, NULL },
	{ NULL,					PMENU_ALIGN_CENTER, NULL, NULL },
	{ NULL,					PMENU_ALIGN_CENTER, NULL, NULL },
	{ "Join Henchmen Team",		PMENU_ALIGN_LEFT, NULL, CTFJoinTeam1 },
	{ NULL,					PMENU_ALIGN_LEFT, NULL, NULL },
	{ "Join Agent Team",		PMENU_ALIGN_LEFT, NULL, CTFJoinTeam2 },
	{ NULL,					PMENU_ALIGN_LEFT, NULL, NULL },
...
//	if (!((int)dmflags->value & DF_CTF_FORCEJOIN)) {
	if (!((int)dmflags->value & DF_CTF_FORCEJOIN) && !(ent->isabot)) {
		// start as 'observer'
