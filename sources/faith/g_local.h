...
//ZOID
//Azrael
	int 			holylevel;		//This is the level that the player has attained
	int			captures;		//The number of captures he has made in this life.
	int			mana;			//This is wether the player has the capacity to cast a spell
	int 			jump;			//This is wether the player has activated jump;
//Azrael
