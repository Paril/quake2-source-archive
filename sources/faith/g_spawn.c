...
void SP_item_angel_statue (edict_t *self);
void SP_misc_fire (edict_t *self);
void SP_misc_torch (edict_t *self);
void SP_item_red_statue (edict_t *self);
void SP_item_blue_statue (edict_t *self);
//Azrael
...
//Azrael  
	...
	{"item_blue_statue", SP_item_blue_statue},
	{"item_red_statue", SP_item_red_statue},
	{"misc_torch", SP_misc_torch},
	{"misc_fire", SP_misc_fire},
	{"item_angel_statue", SP_item_angel_statue},
