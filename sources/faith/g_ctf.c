...
//Azrael
				if (ctf_team == CTF_TEAM1) {
				gi.sound (ent, CHAN_RELIABLE+CHAN_NO_PHS_ADD+CHAN_VOICE, gi.soundindex("ctf/redcapture.wav"), 1, ATTN_NONE, 0);
				}

				if (ctf_team == CTF_TEAM2) {
				gi.sound (ent, CHAN_RELIABLE+CHAN_NO_PHS_ADD+CHAN_VOICE, gi.soundindex("ctf/bluecapture.wav"), 1, ATTN_NONE, 0);
				}
//Azrael
...
void CTFHasTech(edict_t *who)
{
	if (level.time - who->client->ctf_lasttechmsg > 2) {
		gi.centerprintf(who, "You already have a RUNE.");
...
pmenu_t joinmenu[] = {
	...
	{ NULL,					PMENU_ALIGN_CENTER, NULL, NULL },
	{ NULL,					PMENU_ALIGN_CENTER, NULL, NULL },
	{ "Join Satanic Team",		PMENU_ALIGN_LEFT, NULL, CTFJoinTeam1 },
	{ NULL,					PMENU_ALIGN_LEFT, NULL, NULL },
	{ "Join Christian Team",		PMENU_ALIGN_LEFT, NULL, CTFJoinTeam2 },
	{ NULL,					PMENU_ALIGN_LEFT, NULL, NULL },
...
int CTFUpdateJoinMenu(edict_t *ent)
{
	...
	joinmenu[4].text = "Join Satanic Team";
	joinmenu[4].SelectFunc = CTFJoinTeam1;
	joinmenu[6].text = "Join Christian Team";
