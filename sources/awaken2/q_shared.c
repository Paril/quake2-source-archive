...
{
	static float sr;			// static to help MS compiler fp bugs
	static float sp;			//
	static float sy;			//
	static float cr;			//
	static float cp;			//
	...
	angle = DEG2RAD(angles[YAW]);																	//CW
	sy = sin(angle);
	cy = cos(angle);
	angle = DEG2RAD(angles[PITCH]);																	//CW
	sp = sin(angle);
	cp = cos(angle);
	angle = DEG2RAD(angles[ROLL]);																	//CW
	sr = sin(angle);
	cr = cos(angle);
