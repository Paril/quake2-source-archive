...
// HOLY WARS
	// add screen colour blend for player status
	if (ent->client->plstatus == HERETIC)
		SV_AddBlend (0, 0.9, 0, 0.2, ent->client->ps.blend);
// end HOLY WARS
...
// HWv2.1
		if (hw_scoreboard->value)
			...
			// standard scoreboard (this line was already here)
