...
// ARTIFACT QUAKE 2: I put in some comments to remind myself what everything does here. :)
...
// RAFAEL
#define EF_IONRIPPER		0x00100000          //AQ2: Leaves a tiny rust particle trail and gives a VERY small glow.
#define EF_GREENGIB			0x00200000          //AQ2: Just like the bloody gib effect, but green blood.
#define	EF_BLUEHYPERBLASTER 0x00400000           //AQ2: Glows blue, like the old quad in GL.
#define EF_SPINNINGLIGHTS	0x00800000                 //AQ2: Turns it upside down and rotates at double speed, and makes a funky disco light.
#define EF_PLASMA			0x01000000          //AQ2: Makes it transparent and glowing red.
#define EF_TRAP				0x02000000   //AQ2: Does a wacky plasma fountain effect.

//ROGUE
#define EF_TRACKER			0x04000000          //AQ2: Sucks all the light from around the object.
#define	EF_DOUBLE			0x08000000   //AQ2: Activates shaded transaparency shells? Also puts up a white one.
#define	EF_SPHERETRANS		0x10000000   //AQ2: Very nice transparency. VERY transparent.
#define EF_TAGTRAIL			0x20000000          //AQ2: Very bright yellow light around object, and small yellow particles dance on it.
#define EF_HALF_DAMAGE		0x40000000          //AQ2: Activates shaded transparency shells? Also puts up a white one.
#define EF_TRACKERTRAIL		0x80000000          //AQ2: Sucks away all light, but with red at the outskirts. Plus, black static sphere.
//ROGUE
...
#define	MZ_TRACKER			35 //AQ2: Black flash
#define	MZ_NUKE1			36 //AQ2: Red flash
#define	MZ_NUKE2			37 //AQ2: Yellow flash
#define	MZ_NUKE4			38 //AQ2: Blue flash
#define	MZ_NUKE8			39 //AQ2: Cyan flash
//ROGUE
...
//ROGUE
	...
	TE_CHAINFIST_SMOKE,
	TE_ELECTRIC_SPARKS,
	TE_TRACKER_EXPLOSION,	//AQ2: {position origin}, Makes a silent explosion of black particles
	TE_TELEPORT_EFFECT,		//AQ2: {position origin}, The old Quake 1 teleport effect (sans sound)
	TE_DBALL_GOAL,		//AQ2: {position origin}, The old Quake 1 teleport effect (sans sound)
	TE_WIDOWBEAMOUT,
	TE_NUKEBLAST,			//AQ2: {position origin}, Fast expanding sphere of flashy white snow
	TE_WIDOWSPLASH,		//AQ2: {position origin}, Slow, tossed expanding sphere of red and white
	TE_EXPLOSION1_BIG, 		//AQ2: {position origin}, Explosion light and sound and unknown model
	TE_EXPLOSION1_NP,		//AQ2: {position origin}, Explosion light and sound. No particles
	TE_FLECHETTE
//ROGUE
} temp_event_t;
