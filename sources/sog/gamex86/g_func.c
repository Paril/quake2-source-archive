...
// ADDED EXTRA SOUNDS - skid
// Skid
	if(ent->style==1)
	{
//		ent->moveinfo.sound_start = gi.soundindex ("idg3world/plats/medplat1.wav");
//		ent->moveinfo.sound_end = gi.soundindex ("idg3world/plats/medplat2.wav");
	...
	{
//		ent->moveinfo.sound_start = gi.soundindex ("idg3world/plats/plat1.wav");
//		ent->moveinfo.sound_end = gi.soundindex ("idg3world/plats/plat2.wav");
		ent->moveinfo.sound_start = gi.soundindex ("plats/pt1_strt.wav");
		ent->moveinfo.sound_middle = gi.soundindex ("plats/pt1_mid.wav");
		ent->moveinfo.sound_end = gi.soundindex ("plats/pt1_end.wav");
	}
	...
	{
		ent->moveinfo.sound_start = gi.soundindex ("idg2world/elvstart.wav");
		ent->moveinfo.sound_end = gi.soundindex ("idg2world/elvstop.wav");
	}
	else if(ent->style ==4)
	{
		ent->moveinfo.sound_start = gi.soundindex ("idg1world/elvstart.wave");
		ent->moveinfo.sound_start = gi.soundindex ("idg1world/elvstop.wave");
	}
	else
	{
// ADDED EXTRA SOUNDS - skid END
...
// skid added
	if((self->movedir[2]!=-1) &&
	   (self->movedir[2]!=1) &&
	   ((int)sogflags->value & SOG_USE_KEY) &&       // Arno added
	   ((other->client->resp.player_class== CLASS_DOOM) || 
	   (other->client->resp.player_class == CLASS_WOLF)))
	{
		if(!(other->client->latched_buttons & BUTTON_USE)) 
			return;
...
// Skid added
	if(ent->style==1)
		ent->moveinfo.sound_start = gi.soundindex ("idg2world/switchon.wav");
	else if (ent->style==2)
		ent->moveinfo.sound_start = gi.soundindex ("idg2world/switchoff.wav");
	else if (ent->style==3)
		ent->moveinfo.sound_start = gi.soundindex ("idg3world/switchon.wav");
	else if (ent->style==4)
		ent->moveinfo.sound_start = gi.soundindex ("idg3world/switchoff.wav"); 
	else if (ent->style == 5)
		ent->moveinfo.sound_start = gi.soundindex ("idg1world/switchon.wav");
	else if (ent->style == 6)
		ent->moveinfo.sound_start = gi.soundindex ("idg1world/switchoff.wav");
	else
	{
// Skid end
		if (ent->sounds != 1)
...
// skid added
		...
		other->client->resp.player_class== CLASS_WOLF))
	{
		...
		other->client->dlasttouchsound = level.time + 0.2;
//		if(!(other->client->buttons & BUTTON_USE))
//			return;
	}
// Doom guy stuff - end
...
//SKid - DM2 - set item for respawn if its blocking a door		
			if((self->style && other->item) &&
			   (other->item->flags & (IT_Q1|IT_DOOM|IT_WOLF)))
			{
				SetRespawn(other, (float)(self->wait + 1.0));
				return;
			}
//ALERT
			else if(other->svflags & SVF_DEADMONSTER)
				G_FreeEdict(other);
//
			else if (other)
				BecomeExplosion1 (other);
...
// so let it just squash the object to death real fast
	if (self->moveinfo.wait >= 0 || self->style)     //if (self->moveinfo.wait >= 0)
	{
...
// Skid added
	...
	{
//		case 1:
//			ent->moveinfo.sound_start = gi.soundindex  ("idg3world/doors/stndr1.wav");
//			ent->moveinfo.sound_end = gi.soundindex  ("idg3world/doors/stndr2.wav");
//			break;
		case 2:
			ent->moveinfo.sound_start = gi.soundindex  ("idg2world/dooropen.wav");
			ent->moveinfo.sound_end = gi.soundindex  ("idg2world/doorclose.wav");
			break;
		case 3:
			ent->moveinfo.sound_start = gi.soundindex  ("idg2world/dooropen.wav");
			ent->moveinfo.sound_end = gi.soundindex  ("idg2world/doorclose.wav");
			break;
//		case 4:
//			ent->moveinfo.sound_start = gi.soundindex  ("idg3world/doors/ddoor1.wav");
//			ent->moveinfo.sound_end = gi.soundindex  ("idg3world/doors/ddoor2.wav");
//			break;
//		case 5:		
//			ent->moveinfo.sound_start = gi.soundindex  ("idg3world/doors/doormv1.wav");
//			ent->moveinfo.sound_end = gi.soundindex  ("idg3world/doors/drclos4.wav");
//			break;
//		case 6:
//			ent->moveinfo.sound_start = gi.soundindex  ("idg3world/doors/hydro1.wav");
//			ent->moveinfo.sound_end = gi.soundindex  ("idg3world/doors/hydro2.wav");
//			break;
		case 7:
			ent->moveinfo.sound_start = gi.soundindex  ("idg2world/dooropen2.wav");
			ent->moveinfo.sound_end = gi.soundindex  ("idg2world/doorclose2.wav");
			break;
		case 8:
			ent->moveinfo.sound_start = gi.soundindex  ("idg1world/dooropen.wav");
			ent->moveinfo.sound_end = gi.soundindex  ("idg1world/doorclose.wav");
			break;
		case 9:
			ent->moveinfo.sound_start = gi.soundindex  ("idg1world/dooropen2.wav");
			ent->moveinfo.sound_end = gi.soundindex  ("idg1world/dooropen2.wav");
			break;
	}
	else
	{
...
// SKid added
			if(((self->style || level.game != CLASS_Q2) && other->item) &&
			   (other->item->flags & (IT_Q1|IT_DOOM|IT_WOLF)))
			{
				SetRespawn(other, (float)(self->wait + 1.0));
				return;
...
/*		if(self->style)
		{
			//gi.sound (self, CHAN_NO_PHS_ADD+CHAN_VOICE, gi.soundindex ("q1world/plats/train2.wav"), 1, ATTN_STATIC, 0);
			self->s.sound = self->moveinfo.sound_start;
gi.dprintf("Playing Func_train middle sound\n");
		}
		else*/
			self->s.sound = self->moveinfo.sound_middle;
	}
...
//Skid added
	if(self->style)
	{
		self->moveinfo.sound_start = gi.soundindex ("idg3world/plats/train2.wav");
		self->moveinfo.sound_middle = gi.soundindex ("idg3world/plats/train1.wav");
		self->moveinfo.sound_end = gi.soundindex ("idg3world/plats/train2.wav");
	}
	else 
//End Skid
		if (st.noise)
...
// Skid added DM6		
	...
	{
		self->s.sound = self->moveinfo.sound_middle;
		//gi.sound (self, CHAN_VOICE, self->moveinfo.sound_middle, 1, ATTN_STATIC, 0);
	}
// Skid added 
}
...
/*
	if(ent->style==1)
	{
		ent->moveinfo.sound_start = gi.soundindex ("idg3world/doors/basesec2.wav");
		ent->moveinfo.sound_middle = gi.soundindex ("idg3world/doors/basesec1.wav");
		ent->moveinfo.sound_end = gi.soundindex ("idg3world/doors/basesec2.wav");
	}
	else if(ent->style==2)
	{	
		if(strcmp(level.mapname,"qe1m3"))
		ent->moveinfo.sound_start = gi.soundindex ("idg3world/doors/winch2.wav");
		ent->moveinfo.sound_middle = gi.soundindex ("idg3world/doors/latch2.wav");
		ent->moveinfo.sound_end = gi.soundindex ("idg3world/doors/drclos4.wav");
	}
	else
	{	
