...
DLL_API signed char		F_API FSOUND_Init(int mixrate, int maxsoftwarechannels, int vcmmode);
...
// File functions
DLL_API FSOUND_SAMPLE *	F_API FSOUND_Sample_LoadWav(int index, const char *filename, unsigned int mode);
DLL_API FSOUND_SAMPLE *	F_API FSOUND_Sample_LoadMpeg(int index, const char *filename, unsigned int mode);
DLL_API FSOUND_SAMPLE *	F_API FSOUND_Sample_LoadRaw(int index, const char *filename, unsigned int mode);
...
//DLL_API FSOUND_STREAM *	F_API FSOUND_Stream_Open(const char *filename, unsigned int mode, int samplerate);
//DLL_API FSOUND_STREAM *	F_API FSOUND_Stream_OpenWav(const char *filename, unsigned int mode);
DLL_API FSOUND_STREAM *	F_API FSOUND_Stream_OpenMpeg(const char *filename, unsigned int mode);
DLL_API int 			F_API FSOUND_Stream_Play(int channel, FSOUND_STREAM *stream);
//DLL_API int 			F_API FSOUND_Stream_PlayAttrib(int channel, FSOUND_STREAM *stream, int freq, int vol, int pan, float *pos, float *vel);
...
DLL_API void F_API FSOUND_File_SetCallbacks(unsigned int (*OpenCallback)(const char *name),
