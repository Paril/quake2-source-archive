...
// Diff head models -Skid
...

	{
		...
		gibname = "models/objects/idg3head/tris.md2";
...

	{
		...
		gibname ="models/objects/idg2head/tris.md2";
...

	{
		...
		gibname ="models/objects/idg1head/tris.md2";
...
void SP_misc_teleporter (edict_t *ent)
{
...

	{
		...
		gi.soundindex("idg3world/teleport.wav");

		ent->s.sound = gi.soundindex ("idg3world/hum1.wav");
