...
//ZOID
#define MOD_GRAPPLE			66 //K2:Changed from 34 to 66
//ZOID
...
typedef struct
{
	...
	//K2:Begin 
	float		old_aggr;	//1-5 Set when bot picks up BFK or homing
...
//ZOID
	...
	//K2:Begin
	float		k2_regeneration_time; //Used for regeneration key
	float		k2_key_framenum; //Used for counting down keys
	int			key;
	qboolean	took_key;
	...
	float		next_key_pickup;
	qboolean	k2cmd;
	float		next_botnum_command;
...
//ERASER
	...
	//K2:Begin
	edict_t		*prev_owner;  // for previous owner of dropped keys
	                          //they can't have it back till they respawn
	                          //or another player has had it
	int			homing_speed; //used for homing key projectile speed
	float		soundframe;
	qboolean	hookout;
	float		hook_timeout;
...
//K2:Begin Required for use in external functions
