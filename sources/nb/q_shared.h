...
// #include "q_shared.h" //-- included first by ALL program modules
...
/*
// NEWCODE: Neuralbot: this is used for when i allocate memory for those 40,000 floats
// that make up 4 strands of DNA 
