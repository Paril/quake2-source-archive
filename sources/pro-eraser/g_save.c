...
//ZOID
	...
	players_per_team = gi.cvar ("players_per_team", "4", CVAR_SERVERINFO|CVAR_LATCH|CVAR_ARCHIVE);
	addteam = gi.cvar ("addteam", "", CVAR_SERVERINFO);
	teamplay = gi.cvar ("teamplay", "0", CVAR_SERVERINFO|CVAR_LATCH|CVAR_ARCHIVE);
	ctf_auto_teams = gi.cvar ("ctf_auto_teams", "0", CVAR_SERVERINFO);
