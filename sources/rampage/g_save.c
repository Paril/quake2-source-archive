...
field_t fields[] = {
	...
	{"pickup_master", FOFS(pickup_master), F_EDICT, FFL_NOSPAWN},
	{"bounce_amount", FOFS(bounce_amount), F_INT},
	{"gib_bleed_time", FOFS(gib_bleed_time), F_FLOAT},
	{"gib_bleed_dir", FOFS(gib_bleed_dir), F_VECTOR},
...
void  InitGame (void)
{
	...
	sv_maxvelocity = gi.cvar ("sv_maxvelocity", "10000", 0);
