...
#define	GAMEVERSION	"Rampage mod v1.3a"
...
#define AI_SHOOTSROCKET			0x00040000 	
...
// g_weapon.c
//
void ThrowDebris (edict_t *self, char *modelname, float speed, vec3_t origin, vec3_t dir);
