...
void jorgBFG (edict_t *self)
{
	...
	/*void monster_fire_bfg (edict_t *self, 
							 ...
							 float damage_radius, 
							 int flashtype)*/
	monster_fire_bfg (self, start, dir, damage, 300, 100, 200, MZ2_JORG_BFG_1);
}	
...
void jorg_firebullet_right (edict_t *self)
{
	...
	monster_fire_bullet (self, start, forward, damage, 4, DEFAULT_BULLET_HSPREAD, DEFAULT_BULLET_VSPREAD, MZ2_JORG_MACHINEGUN_R1);
}	
...
void jorg_firebullet_left (edict_t *self)
{
	...
	monster_fire_bullet (self, start, forward, damage, 4, DEFAULT_BULLET_HSPREAD, DEFAULT_BULLET_VSPREAD, MZ2_JORG_MACHINEGUN_L1);
}	
