...
void ED_CallSpawn (edict_t *ent)
{
	...
	//K2:Eliminate monster_spawn messages and free the edict
	if(strstr(ent->classname,"monster") ||
	   strstr(ent->classname,"insane")  ||
	   strstr(ent->classname,"target_actor"))
	{
		G_FreeEdict(ent);
		return;
	}
...
// frags
//K2:Begin: yt changed to 10 to allow for frags header
"xr	-50 "
"yt 10 "
"num 3 14"
;
