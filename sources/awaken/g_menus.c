...
//		Game settings...
		...
		case VOTE_MAP:
			...
			sprintf(text, "Proposal: change to level \"%s\"", settings->g_maplist[settings->map - 1]);
			break;

		case VOTE_CONFIG:
			sprintf(text, "Proposal: execute the config script \"%s\"", settings->g_configlist[settings->config - 1]);
			break;

		case VOTE_MATCH:
			sprintf(text, "Proposal: switch %s Match mode", (settings->match)?"ON":"OFF");
			break;
		...
		case VOTE_TIMELIMIT:
			...
			sprintf(text, "Proposal: change the timelimit to %d min(s)", settings->timelimit);
			break;
		...
		case VOTE_FRAGLIMIT:
			...
			sprintf(text, "Proposal: change the fraglimit to %d", settings->fraglimit);
			break;
		...
		case VOTE_CAPLIMIT:
			...
			sprintf(text, "Proposal: change the capturelimit to %d", settings->caplimit);
			break;

		case VOTE_GRAPPLE:
			sprintf(text, "Proposal: switch %s the Grapple", (settings->hook)?"ON":"OFF");
			break;

		case VOTE_GRAPPLE_OFFHAND:
			sprintf(text, "Proposal: the Grapple is %s", (settings->hook_offhand)?"Off-hand":"NOT Off-hand");
			break;

//		Weapon settings...

		case VOTE_GAUSSPISTOL:
			sprintf(text, "Proposal: switch %s the Gauss Pistol", (settings->gausspistol)?"ON":"OFF");
			break;

		case VOTE_MAC10:
			sprintf(text, "Proposal: switch %s the Mac-10", (settings->mac10)?"ON":"OFF");
			break;

		case VOTE_JACKHAMMER:
			sprintf(text, "Proposal: switch %s the Jackhammer", (settings->jackhammer)?"ON":"OFF");
			break;

		case VOTE_C4:
			sprintf(text, "Proposal: switch %s C4 Explosives", (settings->c4)?"ON":"OFF");
			break;

		case VOTE_TRAPS:
			sprintf(text, "Proposal: switch %s Traps", (settings->traps)?"ON":"OFF");
			break;

		case VOTE_ESG:
			sprintf(text, "Proposal: switch %s the Explosive Spike Gun", (settings->esg)?"ON":"OFF");
			break;

		case VOTE_ROCKETLAUNCHER:
			sprintf(text, "Proposal: switch %s the Rocket Launcher", (settings->rocketlauncher)?"ON":"OFF");
			break;

		case VOTE_FLAMETHROWER:
			sprintf(text, "Proposal: switch %s the Flaemthrower", (settings->flamethrower)?"ON":"OFF");
			break;

		case VOTE_RAILGUN:
			sprintf(text, "Proposal: switch %s the Railgun", (settings->railgun)?"ON":"OFF");
			break;

		case VOTE_SHOCKRIFLE:
			sprintf(text, "Proposal: switch %s the Shock Rifle", (settings->shockrifle)?"ON":"OFF");
			break;

		case VOTE_AGM:
			sprintf(text, "Proposal: switch %s the AG Manipulator", (settings->agm)?"ON":"OFF");
			break;

		case VOTE_DISCLAUNCHER:
			sprintf(text, "Proposal: switch %s the Disc Launcher", (settings->disclauncher)?"ON":"OFF");
			break;

//		Powerup settings...

		case VOTE_INVULN:
			sprintf(text, "Proposal: switch %s the Invulnerability", (settings->invuln)?"ON":"OFF");
			break;

		case VOTE_QUAD:
			sprintf(text, "Proposal: switch %s the Quad Damage", (settings->quad)?"ON":"OFF");
			break;

		case VOTE_SIPHON:
			sprintf(text, "Proposal: switch %s the Awakening", (settings->siphon)?"ON":"OFF");
			break;

		case VOTE_D89:
			sprintf(text, "Proposal: switch %s the D89", (settings->d89)?"ON":"OFF");
			break;

		case VOTE_HASTE:
			sprintf(text, "Proposal: switch %s the Haste", (settings->haste)?"ON":"OFF");
			break;

		case VOTE_TELE:
			sprintf(text, "Proposal: switch %s the Personal Teleporter", (settings->tele)?"ON":"OFF");
			break;

		case VOTE_ANTIBEAM:
			sprintf(text, "Proposal: switch %s the Beam Reflector", (settings->antibeam)?"ON":"OFF");
			break;

		case VOTE_ENVIRO:
			sprintf(text, "Proposal: switch %s the Personal Teleporter", (settings->enviro)?"ON":"OFF");
			break;

		case VOTE_SILENCER:
			sprintf(text, "Proposal: switch %s the Personal Teleporter", (settings->silencer)?"ON":"OFF");
			break;

		case VOTE_BREATHER:
			sprintf(text, "Proposal: switch %s the Personal Teleporter", (settings->breather)?"ON":"OFF");
			break;

//		dmflags settings...

		case VOTE_NOHEALTH:
			sprintf(text, "Proposal: switch %s the No Health dmflag", (settings->no_health)?"ON":"OFF");
			break;

		case VOTE_NOITEMS:
			sprintf(text, "Proposal: switch %s the No Items dmflag", (settings->no_items)?"ON":"OFF");
			break;

		case VOTE_WEAPONSSTAY:
			sprintf(text, "Proposal: switch %s the Weapons Stay dmflag", (settings->weapons_stay)?"ON":"OFF");
			break;

		case VOTE_NOFALLING:
			sprintf(text, "Proposal: switch %s the No Falling dmflag", (settings->no_falling)?"ON":"OFF");
			break;

		case VOTE_NOARMOR:
			sprintf(text, "Proposal: switch %s the No Armor dmflag", (settings->no_armor)?"ON":"OFF");
			break;

		case VOTE_INFINITEAMMO:
			sprintf(text, "Proposal: switch %s the Infinite Ammo dmflag", (settings->infinite_ammo)?"ON":"OFF");
			break;

		case VOTE_QUADDROP:
			sprintf(text, "Proposal: switch %s the Quad Drop dmflag", (settings->quad_drop)?"ON":"OFF");
			break;

		case VOTE_FASTSWITCH:
			sprintf(text, "Proposal: switch %s the Fast Switch dmflag", (settings->fast_switch)?"ON":"OFF");
			break;

		case VOTE_EXTRAITEMS:
			sprintf(text, "Proposal: switch %s the Extra Items dmflag", (settings->extra_items)?"ON":"OFF");
			break;

		case VOTE_NOREPLACEMENTS:
			sprintf(text, "Proposal: switch %s the No Replacements dmflag", (settings->no_replacements)?"ON":"OFF");
			break;

		case VOTE_NOTECHS:
			sprintf(text, "Proposal: switch %s the No CTF Techs dmflag", (settings->no_techs)?"ON":"OFF");
			break;

		case VOTE_CTFSPAWNS:
			sprintf(text, "Proposal: switch %s the CTF Spawns Only dmflag", (settings->ctf_spawns)?"ON":"OFF");
			break;

//		AwakenBot settings...

		case VOTE_ADDBOTS:
			sprintf(text, "Proposal: add %d AwakenBots", settings->bots_added);
			break;

		case VOTE_REMOVEBOTS:
			sprintf(text, "Proposal: remove %d AwakenBots", settings->bots_removed);
			break;

		case VOTE_REMOVEALLBOTS:
			sprintf(text, "Proposal: remove ALL AwakenBots");
			break;
...
//	Adding AwakenBots.
	...
	{
		sprintf(text, "Add AwakenBots:    %2d", settings->bots_added);
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeNumBotsAdded);
	}
	else
	{
		sprintf(text, "Add AwakenBots:    [LOCKED]");
	...
	if ((int)sv_vote_allow_bots->value)
	{
		sprintf(text, "Remove AwakenBots: %2d", settings->bots_removed);
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeNumBotsRemoved);
	}
	else
	{
		sprintf(text, "Remove AwakenBots: [LOCKED]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
...
void Vote_DMFlagsUpdate(edict_t *ent, pmenuhnd_t *setmenu)
{
	...
	{
		sprintf(text, "Weapons Stay:        %s", settings->weapons_stay ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeWeaponsStay);
	}
	else
	{
		sprintf(text, "Weapons Stay:        [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "No Falling Damage:   %s", settings->no_falling ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeNoFalling);
	}
	else
	{
		sprintf(text, "No Falling Damage:   [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Infinite Ammo:       %s", settings->infinite_ammo ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeInfiniteAmmo);
	}
	else
	{
		sprintf(text, "Infinite Ammo:       [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Fast Weapon Switch:  %s", settings->fast_switch ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeFastSwitch);
	}
	else
	{
		sprintf(text, "Fast Weapon Switch:  [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Extra Items:         %s", settings->extra_items ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeExtraItems);
	}
	else
	{
		sprintf(text, "Extra Items:         [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Vanilla Q2 Powerups: %s", settings->no_replacements ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeNoReplacements);
	}
	else
	{
		sprintf(text, "Vanilla Q2 Powerups: [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "No CTF Techs:        %s", settings->no_techs ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeCTFNoTechs);
	}
	else
	{
		sprintf(text, "No CTF Techs:        [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "CTF Spawns Only:     %s", settings->ctf_spawns ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeCTFSpawnsOnly);
	}
	else
	{
		sprintf(text, "CTF Spawns Only:     [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
...
void Vote_PowerupsUpdate(edict_t *ent, pmenuhnd_t *setmenu)
{
	...
	{
		sprintf(text, "Invulnerability:     %s", settings->invuln ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeInvuln);
	}
	else
	{
		sprintf(text, "Invulnerability:     [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Quad Damage:         %s", settings->quad ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeQuad);
	}
	else
	{
		sprintf(text, "Quad Damage:         [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "The Awakening:       %s", settings->siphon ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeSiphon);
	}
	else
	{
		sprintf(text, "The Awakening:       [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "D89 (Needle):        %s", settings->d89 ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeD89);
	}
	else
	{
		sprintf(text, "D89 (Needle):        [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Personal Teleporter: %s", settings->tele ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeTele);
	}
	else
	{
		sprintf(text, "Personal Teleporter: [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Beam Reflector:      %s", settings->antibeam ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeAntibeam);
	}
	else
	{
		sprintf(text, "Beam Reflector:      [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Environment Suit:    %s", settings->enviro ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeEnviro);
	}
	else
	{
		sprintf(text, "Environment Suit:    [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Rebreather:          %s", settings->breather ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeBreather);
	}
	else
	{
		sprintf(text, "Rebreather:          [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
...
void Vote_WeaponsUpdate(edict_t *ent, pmenuhnd_t *setmenu)
{
	...
	{
		sprintf(text, "Gauss Pistol:        %s", settings->gausspistol ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeGaussPistol);
	}
	else
	{
		sprintf(text, "Gauss Pistol:        [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Jackhammer:          %s", settings->jackhammer ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeJackhammer);
	}
	else
	{
		sprintf(text, "Jackhammer:          [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "C4 Explosives:       %s", settings->c4 ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeC4);
	}
	else
	{
		sprintf(text, "C4 Explosives:       [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Explosive Spike Gun: %s", settings->esg ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeESG);
	}
	else
	{
		sprintf(text, "Explosive Spike Gun: [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Rocket Launcher:     %s", settings->rocketlauncher ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeRocketLauncher);
	}
	else
	{
		sprintf(text, "Rocket Launcher:     [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Flamethrower:        %s", settings->flamethrower ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeFlamethrower);
	}
	else
	{
		sprintf(text, "Flamethrower:        [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Shock Rifle:         %s", settings->shockrifle ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeShockRifle);
	}
	else
	{
		sprintf(text, "Shock Rifle:         [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "AG Manipulator:      %s", settings->agm ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeAGM);
	}
	else
	{
		sprintf(text, "AG Manipulator:      [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	{
		sprintf(text, "Disc Launcher:       %s", settings->disclauncher ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeDiscLauncher);
	}
	else
	{
		sprintf(text, "Disc Launcher:       [LKD]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
...
//	New map.
	...
	if ((int)sv_vote_allow_map->value)
	{
		...
		{
			sprintf(text, "Map: [INVALID FILE]");
			PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
		}
		else
		{
			if (settings->map == 0)
				sprintf(text, "Map: [Select]");
			else
				sprintf(text, "Map: %s", settings->g_maplist[settings->map - 1]);
			PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeMap);
		}
	}
	else
	{
		sprintf(text, "Map: [LOCKED]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
...
//	Execute config file.
	...
	if ((int)sv_vote_allow_config->value)
	{
		...
		{
			sprintf(text, "Config: [INVALID FILE]");
			PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
		}
		else
		{
			if (settings->config == 0)
				sprintf(text, "Config: [Select]");
			else
				sprintf(text, "Config: %s", settings->g_configlist[settings->config - 1]);
			PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeConfig);
		}
	}
	else
	{
		sprintf(text, "Config: [LOCKED]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	if ((int)sv_vote_allow_match->value)
	{
		...
		{
			sprintf(text, "Match Mode: %s", settings->match ? "ON" : "OFF");
			PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeMatch);
		}
		else
		{
			sprintf(text, "Match Mode: (N/A)");
			PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
		}
	}
	else
	{
		sprintf(text, "Match Mode: [LOCKED]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
...
//	Limits for DM/CTF rules.
	...
	{
		sprintf(text, "Timelimit: %2d mins", settings->timelimit);
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeTimelimit);
	}
	else
	{
		sprintf(text, "Timelimit: [LOCKED]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	if ((int)sv_vote_allow_capturelimit->value)
	{
		...
		{
			sprintf(text, "Capturelimit: %2d", settings->caplimit);
			PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeCapturelimit);
		}
		else
		{
			sprintf(text, "Capturelimit: (N/A)");
			PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
		}
	}
	else
	{
		sprintf(text, "Capturelimit: [LOCKED]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
...
//	Grappling hook.
	...
	{
		sprintf(text, "The Grapple: %s", settings->hook ? "Yes" : "No");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeGrapple);
	}
	else
	{
		sprintf(text, "The Grapple: [LOCKED]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
	...
	if ((int)sv_vote_allow_hook_offhand->value)
	{
		if (settings->hook)
		{
			sprintf(text, "Off-hand Grapple: %s", settings->hook_offhand ? "Yes" : "No");
			PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, Vote_ChangeGrappleOffhand);
		}
		else
		{
			sprintf(text, "Off-hand Grapple: (N/A)");
			PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
		}
	}
	else
	{
		sprintf(text, "Off-hand Grapple: [LOCKED]");
		PMenu_UpdateEntry(setmenu->entries + i, text, PMENU_ALIGN_LEFT, NULL);
	}
	++i;
...
void Op_MenuUpdate(edict_t *ent, pmenuhnd_t *hmenu)
{
	...
	sprintf(text, "Player Selected: [%d]", *n_player);
...
FILE* OpenMOTDFile(void)
{
	...
	if (!*game->string)
	{
		...
		sprintf(filename, "%s/%s", GAMEVERSION, sv_motd_file->string);
	}
	else
	{
		...
		sprintf(filename, "%s/%s", game->string, sv_motd_file->string);
	}
