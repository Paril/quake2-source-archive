...
field_t fields[] =
{
	...
	{"rip_team", FOFS(ripstate), F_INT},
	{"wf_team", FOFS(ripstate), F_INT},
	{"skin", ETOFS(skinnum), F_INT},
	{"team_no", FOFS(ripstate), F_INT},
	{"items_allowed", FOFS(playerclasss), F_INT},
...
void InitGame (void)
{
	...
	ripflags = gi.cvar ("ripflags", "0", CVAR_SERVERINFO);
	fraglimit = gi.cvar ("fraglimit", "0", CVAR_SERVERINFO);
	timelimit = gi.cvar ("timelimit", "0", CVAR_SERVERINFO);
	capturelimit = gi.cvar ("capturelimit", "0", CVAR_SERVERINFO);
	extratime = gi.cvar ("extratime", "0", CVAR_SERVERINFO);
	password = gi.cvar ("password", "", CVAR_USERINFO);
	spectator_password = gi.cvar ("spectator_password", "", CVAR_USERINFO);
	filterban = gi.cvar ("filterban", "1", 0);
	bhole_life = gi.cvar ("bhole_life", "0", CVAR_SERVERINFO | CVAR_LATCH);
	eject = gi.cvar ("eject", "0", CVAR_SERVERINFO | CVAR_LATCH);
