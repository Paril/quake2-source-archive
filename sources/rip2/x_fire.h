/*==========================================================================
//  x_fire.h -- by Patrick Martin               Last updated:  4-24-1998
//--------------------------------------------------------------------------
...
#define RADIUS_FIRE_SPLASH   70

/* Fireflags. */
#define FIREFLAG_SHIFT_Z        0x000000ff      /* Flame shift. */
#define FIREFLAG_DOWN           0x00000100      /* Shift down, not up. */
#define FIREFLAG_DELTA_ALIVE    0x00000200      /* Adjust only if alive. */
#define FIREFLAG_DELTA_BASE     0x00000400      /* Base adjustments. */
#define FIREFLAG_DELTA_VIEW     0x00000800      /* Adjust w/ viewheight. */
#define FIREFLAG_IGNITE         0x00001000      /* Target can ignite. */
...
/* New 'Means of Death'. */
#define MOD_FIRE          100    /* Generic fire (not used) */
#define MOD_FIRE_SPLASH   101    /* Radius damage */
#define MOD_ON_FIRE       102    /* Entity is on fire */
#define MOD_FIREBALL      103    /* Direct hit by fireball */
