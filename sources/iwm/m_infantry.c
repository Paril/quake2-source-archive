...
//	sound_pain1 = SoundIndex ("infantry/infpain1.wav");
//	sound_pain2 = SoundIndex ("infantry/infpain2.wav");
	sound_die1 = SoundIndex ("infantry/infdeth1.wav");
	sound_die2 = SoundIndex ("infantry/infdeth2.wav");

	sound_gunshot = SoundIndex ("infantry/infatck1.wav");
	sound_weapon_cock = SoundIndex ("infantry/infatck3.wav");
	sound_punch_swing = SoundIndex ("infantry/infatck2.wav");
	sound_punch_hit = SoundIndex ("infantry/melee2.wav");
	
//	sound_sight = SoundIndex ("infantry/infsght1.wav");
//	sound_search = SoundIndex ("infantry/infsrch1.wav");
//	sound_idle = SoundIndex ("infantry/infidle1.wav");
