...
//	sound_sight = SoundIndex ("flyer/flysght1.wav");
//	sound_idle = SoundIndex ("flyer/flysrch1.wav");
//	sound_pain1 = SoundIndex ("flyer/flypain1.wav");
//	sound_pain2 = SoundIndex ("flyer/flypain2.wav");
	sound_slash = SoundIndex ("flyer/flyatck2.wav");
	sound_sproing = SoundIndex ("flyer/flyatck1.wav");
	sound_die = SoundIndex ("flyer/flydeth1.wav");

	SoundIndex ("flyer/flyatck3.wav");

	self->s.modelindex = ModelIndex ("models/monsters/flyer/tris.md2");
	VectorSet (self->mins, -16, -16, -24);
	VectorSet (self->maxs, 16, 16, 32);
	self->movetype = MOVETYPE_STEP;
	self->solid = SOLID_BBOX;

	self->s.sound = SoundIndex ("flyer/flyidle1.wav");
