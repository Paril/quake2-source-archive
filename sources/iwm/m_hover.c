...
void SP_monster_hover (edict_t *self)
{
	...
	sound_pain1 = SoundIndex ("hover/hovpain1.wav");	
	sound_pain2 = SoundIndex ("hover/hovpain2.wav");	
	sound_death1 = SoundIndex ("hover/hovdeth1.wav");	
	sound_death2 = SoundIndex ("hover/hovdeth2.wav");	
	sound_sight = SoundIndex ("hover/hovsght1.wav");	
	sound_search1 = SoundIndex ("hover/hovsrch1.wav");	
	sound_search2 = SoundIndex ("hover/hovsrch2.wav");	

	SoundIndex ("hover/hovatck1.wav");	

	self->s.sound = SoundIndex ("hover/hovidle1.wav");

	self->movetype = MOVETYPE_STEP;
	self->solid = SOLID_BBOX;
	self->s.modelindex = ModelIndex("models/monsters/hover/tris.md2");
