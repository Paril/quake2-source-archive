...
void makron_torso (edict_t *ent)
{
	...
	ent->s.frame = 346;
	ent->s.modelindex = ModelIndex ("models/monsters/boss3/rider/tris.md2");
	ent->think = makron_torso_think;
	ent->nextthink = level.time + 2 * FRAMETIME;
	ent->s.sound = SoundIndex ("makron/spine.wav");
	gi.linkentity (ent);
}
...
{
	sound_pain4 = SoundIndex ("makron/pain3.wav");
	sound_pain5 = SoundIndex ("makron/pain2.wav");
	sound_pain6 = SoundIndex ("makron/pain1.wav");
	sound_death = SoundIndex ("makron/death.wav");
	sound_step_left = SoundIndex ("makron/step1.wav");
	sound_step_right = SoundIndex ("makron/step2.wav");
	sound_attack_bfg = SoundIndex ("makron/bfg_fire.wav");
	sound_brainsplorch = SoundIndex ("makron/brain1.wav");
	sound_prerailgun = SoundIndex ("makron/rail_up.wav");
	sound_popup = SoundIndex ("makron/popup.wav");
	sound_taunt1 = SoundIndex ("makron/voice4.wav");
	sound_taunt2 = SoundIndex ("makron/voice3.wav");
	sound_taunt3 = SoundIndex ("makron/voice.wav");
	sound_hit = SoundIndex ("makron/bhit.wav");
