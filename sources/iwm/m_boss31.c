...
void jorg_attack(edict_t *self)
{
	...
	if (random() <= 0.75)
	{
		...
		self->s.sound = SoundIndex ("boss3/w_loop.wav");
...
//	sound_pain1 = SoundIndex ("boss3/bs3pain1.wav");
//	sound_pain2 = SoundIndex ("boss3/bs3pain2.wav");
//	sound_pain3 = SoundIndex ("boss3/bs3pain3.wav");
	sound_death = SoundIndex ("boss3/bs3deth1.wav");
	sound_attack1 = SoundIndex ("boss3/bs3atck1.wav");
	sound_attack2 = SoundIndex ("boss3/bs3atck2.wav");
//	sound_search1 = SoundIndex ("boss3/bs3srch1.wav");
//	sound_search2 = SoundIndex ("boss3/bs3srch2.wav");
//	sound_search3 = SoundIndex ("boss3/bs3srch3.wav");
//	sound_idle = SoundIndex ("boss3/bs3idle1.wav");
	sound_step_left = SoundIndex ("boss3/step1.wav");
	sound_step_right = SoundIndex ("boss3/step2.wav");
	sound_firegun = SoundIndex ("boss3/xfire.wav");
	sound_death_hit = SoundIndex ("boss3/d_hit.wav");

	MakronPrecache ();

	self->movetype = MOVETYPE_STEP;
	self->solid = SOLID_BBOX;
	self->s.modelindex = ModelIndex ("models/monsters/boss3/rider/tris.md2");
	self->s.modelindex2 = ModelIndex ("models/monsters/boss3/jorg/tris.md2");
