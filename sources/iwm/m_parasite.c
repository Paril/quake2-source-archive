...
//	sound_pain1 = SoundIndex ("parasite/parpain1.wav");	
//	sound_pain2 = SoundIndex ("parasite/parpain2.wav");	
	sound_die = SoundIndex ("parasite/pardeth1.wav");	
	sound_launch = SoundIndex("parasite/paratck1.wav");
	sound_impact = SoundIndex("parasite/paratck2.wav");
	sound_suck = SoundIndex("parasite/paratck3.wav");
	sound_reelin = SoundIndex("parasite/paratck4.wav");
//	sound_sight = SoundIndex("parasite/parsght1.wav");
	sound_tap = SoundIndex("parasite/paridle1.wav");
	sound_scratch = SoundIndex("parasite/paridle2.wav");
//	sound_search = SoundIndex("parasite/parsrch1.wav");

	self->s.modelindex = ModelIndex ("models/monsters/parasite/tris.md2");
	VectorSet (self->mins, -16, -16, -24);
