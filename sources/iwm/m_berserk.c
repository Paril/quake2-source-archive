...
void SP_monster_berserk (edict_t *self)
{
	...
	// pre-caches
//	sound_pain  = SoundIndex ("berserk/berpain2.wav");
	sound_die   = SoundIndex ("berserk/berdeth2.wav");
//	sound_idle  = SoundIndex ("berserk/beridle1.wav");
	sound_punch = SoundIndex ("berserk/attack.wav");
//	sound_search = SoundIndex ("berserk/bersrch1.wav");
//	sound_sight = SoundIndex ("berserk/sight.wav");

	self->s.modelindex = ModelIndex("models/monsters/berserk/tris.md2");
	VectorSet (self->mins, -16, -16, -24);
