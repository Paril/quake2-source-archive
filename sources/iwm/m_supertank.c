...
//	sound_pain1 = SoundIndex ("bosstank/btkpain1.wav");
//	sound_pain2 = SoundIndex ("bosstank/btkpain2.wav");
//	sound_pain3 = SoundIndex ("bosstank/btkpain3.wav");
	sound_death = SoundIndex ("bosstank/btkdeth1.wav");
//	sound_search1 = SoundIndex ("bosstank/btkunqv1.wav");
//	sound_search2 = SoundIndex ("bosstank/btkunqv2.wav");

//	self->s.sound = SoundIndex ("bosstank/btkengn1.wav");
	tread_sound = SoundIndex ("bosstank/btkengn1.wav");

	self->movetype = MOVETYPE_STEP;
	self->solid = SOLID_BBOX;
	self->s.modelindex = ModelIndex ("models/monsters/boss1/tris.md2");
