...
void SP_monster_brain (edict_t *self)
{
	...
	sound_chest_open = SoundIndex ("brain/brnatck1.wav");
	sound_tentacles_extend = SoundIndex ("brain/brnatck2.wav");
	sound_tentacles_retract = SoundIndex ("brain/brnatck3.wav");
	sound_death = SoundIndex ("brain/brndeth1.wav");
//	sound_idle1 = SoundIndex ("brain/brnidle1.wav");
//	sound_idle2 = SoundIndex ("brain/brnidle2.wav");
//	sound_idle3 = SoundIndex ("brain/brnlens1.wav");
	//sound_pain1 = SoundIndex ("brain/brnpain1.wav");
	//sound_pain2 = SoundIndex ("brain/brnpain2.wav");
//	sound_sight = SoundIndex ("brain/brnsght1.wav");
//	sound_search = SoundIndex ("brain/brnsrch1.wav");
	sound_melee1 = SoundIndex ("brain/melee1.wav");
	sound_melee2 = SoundIndex ("brain/melee2.wav");
	sound_melee3 = SoundIndex ("brain/melee3.wav");

	self->movetype = MOVETYPE_STEP;
	self->solid = SOLID_BBOX;
	self->s.modelindex = ModelIndex ("models/monsters/brain/tris.md2");
	VectorSet (self->mins, -16, -16, -24);
