...
//		self->s.skinnum = 1;
	...
	if (self->health < 25)
		...
		l = 100;
	gi.sound (self, CHAN_VOICE, SoundIndex (va("player/male/pain%i_%i.wav", l, r)), 1, ATTN_IDLE, 0);
...
void insane_die (edict_t *self, edict_t *inflictor, edict_t *attacker, int damage, vec3_t point)
{
	...
	{
		gi.sound (self, CHAN_VOICE, SoundIndex ("misc/udeath.wav"), 1, ATTN_IDLE, 0);
		for (n= 0; n < 2; n++)
	...
	gi.sound (self, CHAN_VOICE, SoundIndex(va("player/male/death%i.wav", (rand()%4)+1)), 1, ATTN_IDLE, 0);
...
//	static int skin = 0;	//@@
	...
	sound_fist = SoundIndex ("insane/insane11.wav");
	sound_shake = SoundIndex ("insane/insane5.wav");
	sound_moan = SoundIndex ("insane/insane7.wav");
	sound_scream[0] = SoundIndex ("insane/insane1.wav");
	sound_scream[1] = SoundIndex ("insane/insane2.wav");
	sound_scream[2] = SoundIndex ("insane/insane3.wav");
	sound_scream[3] = SoundIndex ("insane/insane4.wav");
	sound_scream[4] = SoundIndex ("insane/insane6.wav");
	sound_scream[5] = SoundIndex ("insane/insane8.wav");
	sound_scream[6] = SoundIndex ("insane/insane9.wav");
	sound_scream[7] = SoundIndex ("insane/insane10.wav");

	self->movetype = MOVETYPE_STEP;
	self->solid = SOLID_BBOX;
	self->s.modelindex = ModelIndex("models/monsters/insane/tris.md2");
