...
void SP_monster_boss2 (edict_t *self)
{
	...
	sound_pain1 = SoundIndex ("bosshovr/bhvpain1.wav");
	sound_pain2 = SoundIndex ("bosshovr/bhvpain2.wav");
	sound_pain3 = SoundIndex ("bosshovr/bhvpain3.wav");
	sound_death = SoundIndex ("bosshovr/bhvdeth1.wav");
	sound_search1 = SoundIndex ("bosshovr/bhvunqv1.wav");

	self->s.sound = SoundIndex ("bosshovr/bhvengn1.wav");

	self->movetype = MOVETYPE_STEP;
	self->solid = SOLID_BBOX;
	self->s.modelindex = ModelIndex ("models/monsters/boss2/tris.md2");
	VectorSet (self->mins, -56, -56, 0);
	VectorSet (self->maxs, 56, 56, 80);
