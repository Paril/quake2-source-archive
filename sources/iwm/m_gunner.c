...
void SP_monster_gunner (edict_t *self)
{
	...
	sound_death = SoundIndex ("gunner/death1.wav");	
//	sound_pain = SoundIndex ("gunner/gunpain2.wav");	
//	sound_pain2 = SoundIndex ("gunner/gunpain1.wav");	
//	sound_idle = SoundIndex ("gunner/gunidle1.wav");	
	sound_open = SoundIndex ("gunner/gunatck1.wav");	
//	sound_search = SoundIndex ("gunner/gunsrch1.wav");	
//	sound_sight = SoundIndex ("gunner/sight1.wav");	
	...
	self->s.modelindex = ModelIndex ("models/monsters/gunner/tris.md2");
	VectorSet (self->mins, -16, -16, -24);
