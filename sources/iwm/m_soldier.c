...
void SP_monster_soldier_x (edict_t *self)
{
	...
	self->s.modelindex = ModelIndex ("models/monsters/soldier/tris.md2");
...
//	sound_idle =	SoundIndex ("soldier/solidle1.wav");
//	sound_sight1 =	SoundIndex ("soldier/solsght1.wav");
//	sound_sight2 =	SoundIndex ("soldier/solsrch1.wav");
	sound_cock =	SoundIndex ("infantry/infatck3.wav");
...
//	sound_pain_light = SoundIndex ("soldier/solpain2.wav");
	sound_death_light =	SoundIndex ("soldier/soldeth2.wav");
...
//	sound_pain = SoundIndex ("soldier/solpain1.wav");
	sound_death = SoundIndex ("soldier/soldeth1.wav");
...
//	sound_pain_ss = SoundIndex ("soldier/solpain3.wav");
	sound_death_ss = SoundIndex ("soldier/soldeth3.wav");
	SoundIndex ("soldier/solatck3.wav");
