...
//	sound_idle1 = SoundIndex ("medic/idle.wav");
//	sound_pain1 = SoundIndex ("medic/medpain1.wav");
//	sound_pain2 = SoundIndex ("medic/medpain2.wav");
	sound_die = SoundIndex ("medic/meddeth1.wav");
//	sound_sight = SoundIndex ("medic/medsght1.wav");
//	sound_search = SoundIndex ("medic/medsrch1.wav");
	sound_hook_launch = SoundIndex ("medic/medatck2.wav");
	sound_hook_hit = SoundIndex ("medic/medatck3.wav");
	sound_hook_heal = SoundIndex ("medic/medatck4.wav");
	sound_hook_retract = SoundIndex ("medic/medatck5.wav");

	SoundIndex ("medic/medatck1.wav");

	self->movetype = MOVETYPE_STEP;
	self->solid = SOLID_BBOX;
	self->s.modelindex = ModelIndex ("models/monsters/medic/tris.md2");
