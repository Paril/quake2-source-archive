...
void SP_monster_floater (edict_t *self)
{
	...
	sound_attack2 = SoundIndex ("floater/fltatck2.wav");
	sound_attack3 = SoundIndex ("floater/fltatck3.wav");
	sound_death1 = SoundIndex ("floater/fltdeth1.wav");
//	sound_idle = SoundIndex ("floater/fltidle1.wav");
//	sound_pain1 = SoundIndex ("floater/fltpain1.wav");
//	sound_pain2 = SoundIndex ("floater/fltpain2.wav");
//	sound_sight = SoundIndex ("floater/fltsght1.wav");

	SoundIndex ("floater/fltatck1.wav");

	self->s.sound = SoundIndex ("floater/fltsrch1.wav");

	self->movetype = MOVETYPE_STEP;
	self->solid = SOLID_BBOX;
	self->s.modelindex = ModelIndex ("models/monsters/float/tris.md2");
