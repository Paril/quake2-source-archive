...
//	sound_pain1		= SoundIndex ("flipper/flppain1.wav");	
//	sound_pain2		= SoundIndex ("flipper/flppain2.wav");	
	sound_death		= SoundIndex ("flipper/flpdeth1.wav");	
	sound_chomp		= SoundIndex ("flipper/flpatck1.wav");
	sound_attack	= SoundIndex ("flipper/flpatck2.wav");
//	sound_idle		= SoundIndex ("flipper/flpidle1.wav");
//	sound_search	= SoundIndex ("flipper/flpsrch1.wav");
//	sound_sight		= SoundIndex ("flipper/flpsght1.wav");

	self->movetype = MOVETYPE_STEP;
	self->solid = SOLID_BBOX;
	self->s.modelindex = ModelIndex ("models/monsters/flipper/tris.md2");
