...
void SP_monster_chick (edict_t *self)
{
	...
	sound_missile_prelaunch	= SoundIndex ("chick/chkatck1.wav");	
	sound_missile_launch	= SoundIndex ("chick/chkatck2.wav");	
	sound_melee_swing		= SoundIndex ("chick/chkatck3.wav");	
	sound_melee_hit			= SoundIndex ("chick/chkatck4.wav");	
	sound_missile_reload	= SoundIndex ("chick/chkatck5.wav");	
	sound_death1			= SoundIndex ("chick/chkdeth1.wav");	
	sound_death2			= SoundIndex ("chick/chkdeth2.wav");	
	sound_fall_down			= SoundIndex ("chick/chkfall1.wav");	
//	sound_idle1				= SoundIndex ("chick/chkidle1.wav");	
//	sound_idle2				= SoundIndex ("chick/chkidle2.wav");	
//	sound_pain1				= SoundIndex ("chick/chkpain1.wav");	
//	sound_pain2				= SoundIndex ("chick/chkpain2.wav");	
//	sound_pain3				= SoundIndex ("chick/chkpain3.wav");	
//	sound_sight				= SoundIndex ("chick/chksght1.wav");	
//	sound_search			= SoundIndex ("chick/chksrch1.wav");	

	self->movetype = MOVETYPE_STEP;
	self->solid = SOLID_BBOX;
	self->s.modelindex = ModelIndex ("models/monsters/bitch/tris.md2");
	VectorSet (self->mins, -16, -16, 0);
