...
void SP_monster_mutant (edict_t *self)
{
	...
	sound_swing = SoundIndex ("mutant/mutatck1.wav");
	sound_hit = SoundIndex ("mutant/mutatck2.wav");
	sound_hit2 = SoundIndex ("mutant/mutatck3.wav");
	sound_death = SoundIndex ("mutant/mutdeth1.wav");
//	sound_idle = SoundIndex ("mutant/mutidle1.wav");
//	sound_pain1 = SoundIndex ("mutant/mutpain1.wav");
//	sound_pain2 = SoundIndex ("mutant/mutpain2.wav");
//	sound_sight = SoundIndex ("mutant/mutsght1.wav");
//	sound_search = SoundIndex ("mutant/mutsrch1.wav");
	sound_step1 = SoundIndex ("mutant/step1.wav");
	sound_step2 = SoundIndex ("mutant/step2.wav");
	sound_step3 = SoundIndex ("mutant/step3.wav");
	sound_thud = SoundIndex ("mutant/thud1.wav");
	
	self->movetype = MOVETYPE_STEP;
	self->solid = SOLID_BBOX;
	self->s.modelindex = ModelIndex ("models/monsters/mutant/tris.md2");
