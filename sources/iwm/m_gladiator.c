...
//	sound_pain1 = SoundIndex ("gladiator/pain.wav");	
//	sound_pain2 = SoundIndex ("gladiator/gldpain2.wav");	
	sound_die = SoundIndex ("gladiator/glddeth2.wav");	
	sound_gun = SoundIndex ("gladiator/railgun.wav");
	sound_cleaver_swing = SoundIndex ("gladiator/melee1.wav");
	sound_cleaver_hit = SoundIndex ("gladiator/melee2.wav");
	sound_cleaver_miss = SoundIndex ("gladiator/melee3.wav");
//	sound_idle = SoundIndex ("gladiator/gldidle1.wav");
//	sound_search = SoundIndex ("gladiator/gldsrch1.wav");
//	sound_sight = SoundIndex ("gladiator/sight.wav");

	self->movetype = MOVETYPE_STEP;
	self->solid = SOLID_BBOX;
	self->s.modelindex = ModelIndex ("models/monsters/gladiatr/tris.md2");
