...
{ 
	// BEGIN Teamplay
	if (!teamplay_MapCheck(ent, other))
		return;
	// END Teamplay
...
void Touch_Plat_Center (edict_t *ent, edict_t *other, cplane_t *plane, csurface_t *surf)
{
	...
	if (ent->enemy)
	{
		if (!teamplay_MapCheck(ent->enemy, other))
			return;
	}
	else
	{
...
void button_fire (edict_t *self)
{
	...
	// BEGIN Teamplay
	if (self->bots_gravity)
		newbots_gravity = self->bots_gravity;
	// END Teamplay
}
...
{
	// BEGIN Teamplay
	if (!teamplay_MapCheck(self, other))
		return;
	// END Teamplay
...
void door_touch (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf)
{
	...
	gsutil_centerprint(other, "%s", self->message);
