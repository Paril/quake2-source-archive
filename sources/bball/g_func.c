...
//M.S. ballcarrier spawnflag
#define DOOR_BALLCARRIER	128
//M.S.
...
void Touch_DoorTrigger (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf)
{
	...
	//M.S. ballcarrier only door
	if ((self->owner->spawnflags & DOOR_BALLCARRIER) && !(
		(other->client && other->client->pers.inventory[ITEM_INDEX(FindItem("BasketBalls"))] )
		|| (other->bot && other->bot->pers.inventory[ITEM_INDEX(FindItem("BasketBalls"))] ) ) )
		return;
	//M.S,	
