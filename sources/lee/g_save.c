...
field_t fields[] = {
	...
	{"mbmobjectives", FOFS(mbmobjectives), F_INT},
	{"mbmtype", FOFS(mbmtype), F_INT},
	{"mbmtimelimit", FOFS(mbmtimelimit), F_INT}
};
...
void InitGame (void)
{
	...
	maxentities = gi.cvar ("maxentities", "2048", CVAR_LATCH);//1024#
	...
	//added
		     mbm = gi.cvar ("mbm", "0", CVAR_LATCH);
	   darkmatch = gi.cvar ("darkmatch", "0", CVAR_LATCH);
	capturelimit = gi.cvar ("capturelimit", "0", CVAR_SERVERINFO);
	drop_all_wep = gi.cvar ("drop_all_wep", "1", CVAR_SERVERINFO);
	        midi = gi.cvar ("midi", "0", CVAR_SERVERINFO);
		   teams = gi.cvar ("teams", "3", CVAR_SERVERINFO);
	   teamlimit = gi.cvar ("teamlimit", "0", CVAR_SERVERINFO);
	   bot_skill = gi.cvar ("bot_skill", "1", CVAR_SERVERINFO);
    weapon_arena = gi.cvar ("weapon_arena", "0", CVAR_SERVERINFO);
	//end of added
