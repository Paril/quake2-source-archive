...
//added 
extern int number_bot;
extern int current_number_bot;					//current of bots in the game
extern int cam_way0, cam_way1;					//deathcam x and y
extern int bot_point_stuff;					//loop number for bot_point
extern int TP_score_types[3], TP_start_bot;	//Teamplay (scoreboard and move)
extern int TP_player_team;						//Teamplay

extern int bot_total_msg_killer;						//Amount of messages for killer
extern int bot_total_msg_killed;						//Amount of messages for killed

extern int bot_name_total;
extern int def_team1, def_team2;				//ctf (amout of bot defening base)

typedef char bot_message_string[80];
extern int bot_loaded[20];

#ifdef MIDI
//has the midi been tried yet?
int miditried;
//midi finish time
float midiendtime;
float server;
