...
void TankBlaster (edict_t *self)
{
	...
	if (strcmp(self->classname, "monster_tank_commander") == 0)
		monster_fire_blaster (self, start, dir, 50, 800, flash_number, EF_BLASTER);
	else
...
void TankMachineGun (edict_t *self)
{
	...
	if (strcmp(self->classname, "monster_tank_commander") == 0)
		monster_fire_shotgun (self, start, forward, 2, 1, DEFAULT_SHOTGUN_HSPREAD, DEFAULT_SHOTGUN_VSPREAD, DEFAULT_SHOTGUN_COUNT, flash_number);
	else
