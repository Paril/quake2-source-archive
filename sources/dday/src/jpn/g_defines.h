...
#define DAMAGE_FIST			10
#define DAMAGE_HELMET		5

#define FLAME_MAG			300

#define MAX_HMG_PITCH		-30			// makes for a 60 degree fireing pitch for HMG
