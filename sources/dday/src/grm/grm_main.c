...
{
	ptrgi->imageindex("scope_grm");
	ptrgi->imageindex("victory_grm");

	ptrgi->soundindex("grm/victory.wav");

	ptrgi->modelindex("players/grm/tris.md2");
	...
	// GRM 
	ptrgi->modelindex("players/grm/w_p38.md2");
	ptrgi->modelindex("players/grm/w_m98k.md2");
	ptrgi->modelindex("players/grm/w_mp40.md2");
	ptrgi->modelindex("players/grm/w_mp43.md2");
	ptrgi->modelindex("players/grm/w_mg42.md2");
	ptrgi->modelindex("players/grm/w_panzer.md2");
	ptrgi->modelindex("players/grm/w_m98ks.md2");
	ptrgi->modelindex("players/grm/a_masher.md2");

	/*faf
	// USA
	ptrgi->modelindex("players/grm/w_colt45.md2");
	ptrgi->modelindex("players/grm/w_m1.md2");
	ptrgi->modelindex("players/grm/w_thompson.md2");
	ptrgi->modelindex("players/grm/w_bar.md2");
	ptrgi->modelindex("players/grm/w_bhmg.md2");
	ptrgi->modelindex("players/grm/w_bazooka.md2");
	ptrgi->modelindex("players/grm/w_m1903.md2");
	ptrgi->modelindex("players/grm/a_grenade.md2");



	// GENERIC
	ptrgi->modelindex("players/grm/w_flame.md2");
	ptrgi->modelindex("players/grm/w_morphine.md2");
	ptrgi->modelindex("players/grm/w_knife.md2");
	ptrgi->modelindex("players/grm/w_binoc.md2");
	*/
}
...
static userdll_export_t userdll_export =
{
	...
	GRM_MOS_List,
	"grm",					//team id
	"grm"					//this is the player model to use when spawning
};
...
userdll_export_t GRMGetAPI(userdll_import_t udit)
{
