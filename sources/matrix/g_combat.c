...
void T_Damage (edict_t *targ, edict_t *inflictor, edict_t *attacker, vec3_t dir, vec3_t point, vec3_t normal, int damage, int knockback, int dflags, int mod)
{
	...
	if (!targ->takedamage)
		return;
	// MATRIX
	damage = MatrixDamage(targ, attacker, damage);
	// MATRIX
...
// MATRIX	meansOfDeath = mod;
	meansOfDeath = mod + MatrixApplyLocationDamage(targ, point, mod, damage);
// MATRIX
	///////////////////////if(leper->value)
	///////////////////////Leper_TDamage (targ, attacker, point, damage, MatrixApplyLocationDamage(targ, point, mod, damage));
