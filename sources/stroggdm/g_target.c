...
void target_laser_think (edict_t *self)
{
  ...
  if (strcmp(self -> classname,"laser_yaya") == 0)
         ...
         {
                 // bit of damage...
                 T_RadiusDamage (self, self, 650, NULL, 200, MOD_TARGET_LASER);
                 ...
                 // bye bye laser
                 G_FreeEdict (self);
				 //G_FreeEdict (self->owner); // Bye bye grenade
	...
	while(1)
	{
		...
		if (strcmp(self -> classname,"laser_yaya") == 0)
		{
			...
			{
				T_RadiusDamage (self, self, 450, NULL, 330, MOD_TARGET_LASER);
				gi.sound (self, CHAN_AUTO, gi.soundindex ("flyer/flydeth1.wav"), 1, ATTN_NORM, 0);
