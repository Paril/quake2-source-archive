...
void SP_monster_soldier_x (edict_t *self)
{
	...
	self->s.modelindex = gi.modelindex ("players/soldier/tris.md2");
...
void make_soldier_shoot (edict_t *self)
{
 vec3_t  start;
 vec3_t  forward;
 vec3_t  end;
 ...
 {
		tr.ent->monsterinfo.currentmove = &soldier_move_attack3;
 }
}
void make_soldier_walk (edict_t *self)
{
 vec3_t  start;
 vec3_t  forward;
 vec3_t  end;
 ...
 if ( tr.ent && ((tr.ent->svflags & SVF_MONSTER) || (tr.ent->client)) )
 {
	 tr.ent->monsterinfo.currentmove = &soldier_move_walk1;
 }
}
void make_soldier_stand (edict_t *self)
{
 vec3_t  start;
 vec3_t  forward;
 vec3_t  end;
 ...
 if ( tr.ent && ((tr.ent->svflags & SVF_MONSTER) || (tr.ent->client)) )
 {
	if ((tr.ent->monsterinfo.currentmove == &soldier_move_stand3) || (random() < 0.8))
		tr.ent->monsterinfo.currentmove = &soldier_move_stand1;
	else
		tr.ent->monsterinfo.currentmove = &soldier_move_stand3;
 }
}
