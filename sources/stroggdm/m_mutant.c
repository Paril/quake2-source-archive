...
void mutant_jump_takeoff (edict_t *self)
{
	...
	self->s.origin[2] += 1;
	VectorScale (forward, 1350, self->velocity);
	self->velocity[2] = 250;
...
mframe_t mutant_frames_jump [] =
{
	ai_charge,	 0,	NULL,
	ai_charge,	20,	NULL,
	ai_charge,	45,	mutant_jump_takeoff,
	ai_charge,	45,	NULL,
	ai_charge,	45,	mutant_check_landing,
	ai_charge,	 0,	NULL,
	ai_charge,	 3,	NULL,
	ai_charge,	 0,	NULL
};
...
void SP_monster_mutant (edict_t *self)
{
	...
	self->s.modelindex = gi.modelindex ("players/mutant/tris.md2");
