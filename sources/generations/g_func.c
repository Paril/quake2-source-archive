...
// Skid
	if(ent->style==1)
	{
		ent->moveinfo.sound_start = gi.soundindex ("q1world/plats/medplat1.wav");
		ent->moveinfo.sound_end = gi.soundindex ("q1world/plats/medplat2.wav");
	}
	else if(ent->style==2)
	{
		ent->moveinfo.sound_start = gi.soundindex ("q1world/plats/plat1.wav");
		ent->moveinfo.sound_end = gi.soundindex ("q1world/plats/plat2.wav");
	}
	else if(ent->style==3)
	{
		ent->moveinfo.sound_start = gi.soundindex ("dworld/Dspstart.wav");
		ent->moveinfo.sound_end = gi.soundindex ("dworld/Dspstop.wav");
	}
	else if(ent->style ==4)
	{
		ent->moveinfo.sound_start = gi.soundindex ("wworld/lift.wave");
		ent->moveinfo.sound_start = gi.soundindex ("wworld/liftstop.wave");
	}
	else
	{
...
// Skid added
	if(ent->style==1)
		ent->moveinfo.sound_start = gi.soundindex ("dworld/Dsswtchn.wav");
	else if (ent->style==2)
		ent->moveinfo.sound_start = gi.soundindex ("dworld/Dsswtchx.wav");
	else if (ent->style==3)
		ent->moveinfo.sound_start = gi.soundindex ("q1world/switch21.wav");
	else if (ent->style==4)
		ent->moveinfo.sound_start = gi.soundindex ("q1world/airbut1.wav"); 
	else if (ent->style == 5)
		ent->moveinfo.sound_start = gi.soundindex ("wworld/switch.wav");
	else if (ent->style == 6)
		ent->moveinfo.sound_start = gi.soundindex ("wworld/switch2.wav");
	else
	{
// Skid end
		if (ent->sounds != 1)
...
// Skid added
	...
	{
		case 1:
			ent->moveinfo.sound_start = gi.soundindex  ("q1world/doors/stndr1.wav");
			ent->moveinfo.sound_end = gi.soundindex  ("q1world/doors/stndr2.wav");
			break;
		case 2:
			ent->moveinfo.sound_start = gi.soundindex  ("dworld/Dsbdopn.wav");
			ent->moveinfo.sound_end = gi.soundindex  ("dworld/Dsbdcls.wav");
			break;
		case 3:
			ent->moveinfo.sound_start = gi.soundindex  ("dworld/Dsdoropn.wav");
			ent->moveinfo.sound_end = gi.soundindex  ("dworld/Dsdorcls.wav");
			break;
		case 4:
			ent->moveinfo.sound_start = gi.soundindex  ("q1world/doors/ddoor1.wav");
			ent->moveinfo.sound_end = gi.soundindex  ("q1world/doors/ddoor2.wav");
			break;
		case 5:		
			ent->moveinfo.sound_start = gi.soundindex  ("q1world/doors/doormv1.wav");
			ent->moveinfo.sound_end = gi.soundindex  ("q1world/doors/drclos4.wav");
			break;
		case 6:
			ent->moveinfo.sound_start = gi.soundindex  ("q1world/doors/hydro1.wav");
			ent->moveinfo.sound_end = gi.soundindex  ("q1world/doors/hydro2.wav");
			break;
		case 7:
			ent->moveinfo.sound_start = gi.soundindex  ("dworld/Dspstart.wav");
			ent->moveinfo.sound_end = gi.soundindex  ("dworld/Dspstop.wav");
			break;
		case 8:
			ent->moveinfo.sound_start = gi.soundindex  ("wworld/dopen.wav");
			ent->moveinfo.sound_end = gi.soundindex  ("wworld/dclose.wav");
			break;
		case 9:
			ent->moveinfo.sound_start = gi.soundindex  ("wworld/dopen2.wav");
			ent->moveinfo.sound_end = gi.soundindex  ("wworld/dclose.wav");
			break;
	}
	else
...
//Skid added
	if(self->style)
	{
		self->moveinfo.sound_start = gi.soundindex ("q1world/plats/train2.wav");
		self->moveinfo.sound_middle = gi.soundindex ("q1world/plats/train1.wav");
		self->moveinfo.sound_end = gi.soundindex ("q1world/plats/train2.wav");
	}
	else 
//End Skid
		if (st.noise)
...
void SP_func_door_secret (edict_t *ent)
{
	...
	if(ent->style==1)
	{
		ent->moveinfo.sound_start = gi.soundindex ("q1world/doors/basesec2.wav");
		ent->moveinfo.sound_middle = gi.soundindex ("q1world/doors/basesec1.wav");
		ent->moveinfo.sound_end = gi.soundindex ("q1world/doors/basesec2.wav");
	}
	else if(ent->style==2)
	{	
//		if(strcmp(level.mapname,"qe1m3"))
			ent->moveinfo.sound_start = gi.soundindex ("q1world/doors/winch2.wav");
		ent->moveinfo.sound_middle = gi.soundindex ("q1world/doors/latch2.wav");
		ent->moveinfo.sound_end = gi.soundindex ("q1world/doors/drclos4.wav");
	}
	else
	{	
