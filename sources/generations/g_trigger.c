...
// Skid added
		...
		ent->noise_index = gi.soundindex ("q1world/misc/secret.wav");
	else if (ent->sounds ==5)
		ent->noise_index = gi.soundindex ("q1world/misc/talk.wav");
	else if (ent->sounds ==6)
		ent->noise_index = gi.soundindex ("q1world/misc/trigger1.wav");
// end Skid
...
//Skid added
			if(self->style)
			{
				...
				gi.sound (activator, CHAN_AUTO, gi.soundindex ("q1world/misc/talk.wav"), 1, ATTN_NORM, 0);
				return;
			}
//End Skid
