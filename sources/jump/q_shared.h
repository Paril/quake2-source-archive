...
void _VectorSubtract (vec3_t veca, vec3_t vecb, vec3_t /*@out@*/out);
void _VectorAdd (vec3_t veca, vec3_t vecb, vec3_t /*@out@*/out);
void _VectorCopy (vec3_t in, vec3_t /*@out@*/out);
...
void Com_sprintf (char /*@out@*/*dest, int size, char *fmt, ...);
