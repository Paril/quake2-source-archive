...
void G_SetClientEffects (edict_t *ent)
{
	...
	// FIXME: When team colors are added, it makes funky colors with quad colors, etc.
	//        Possible solution: don't use color for quad, etc.
	//        I don't think it's a real problem.  I will do nothing for now.
