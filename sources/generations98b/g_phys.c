...
qboolean SV_RunThink (edict_t *ent)
{
	...
	if (!ent->think)
	{
		gi.dprintf("NULL ent classname :%s\n",ent->classname);
...
// check for water transition
	...
	{
// Skid added
		if(ent->client && ent->client->resp.player_class == CLASS_Q1)
			gi.positioned_sound (old_origin, g_edicts, CHAN_AUTO, gi.soundindex("q1guy/h2ohit1.wav"), 1, 1, 0);
		else
// end Skid
