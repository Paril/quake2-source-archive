...
void ChangeWeapon (edict_t *ent)
{
	...
	// ### Hentai ### BEGIN
	if (vwep->value)	// DEREK - added check for vweap cvar
	{
...
void Weapon_Generic (edict_t *ent, int FRAME_ACTIVATE_LAST, int FRAME_FIRE_LAST, int FRAME_IDLE_LAST, int FRAME_DEACTIVATE_LAST, int *pause_frames, int *fire_frames, void (*fire)(edict_t *ent))
{
	...
	{
		// DEREK - 6/11/98 - added optional fast weapon switching - thanks CRT
		// if (ent->client->ps.gunframe == FRAME_ACTIVATE_LAST)
		if (ent->client->ps.gunframe == FRAME_ACTIVATE_LAST || fastweap->value)
		// DEREK - end
		{
	...
	if ((ent->client->newweapon) && (ent->client->weaponstate != WEAPON_FIRING))
	{
		...
		// DEREK - end
		// ### Hentai ### BEGIN
		if (vwep->value)	// DEREK - added vweap cvar check
		{
