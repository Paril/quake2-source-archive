...
void InitGame (void)
{
	...
	// noset vars
	dedicated = gi.cvar ("dedicated", "0", CVAR_READONLY);

	// latched vars
	sv_cheats = gi.cvar ("cheats", "0", CVAR_SERVERINFO|CVAR_LATCH_SERVER);
	...
	maxclients = gi.cvar ("maxclients", "4", CVAR_SERVERINFO | CVAR_LATCH_SERVER);
	maxspectators = gi.cvar ("maxspectators", "4", CVAR_SERVERINFO);
	deathmatch = gi.cvar ("deathmatch", "0", CVAR_SERVERINFO|CVAR_LATCH_SERVER);
	coop = gi.cvar ("coop", "0", CVAR_LATCH_SERVER);
	skill = gi.cvar ("skill", "1", CVAR_LATCH_SERVER);
	maxentities = gi.cvar ("maxentities", "1024", CVAR_LATCH_SERVER);
	...
	glmod = gi.cvar ("glmod", "", CVAR_USERINFO);
...
void ReadLevel (char *filename)
{
	...
	globals.numEdicts = maxclients->floatVal+1;
