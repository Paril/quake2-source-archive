...
void G_SetClientEffects (edict_t *ent)
{
	...
	// MATT's modifications here...
	check_effects(ent);	// In g_bop.c code
	lagged_out(ent);	// does nothing except do ping stuff
...
void G_SetClientFrame (edict_t *ent)
{
	...
	if (!ent->groundentity && client->anim_priority <= ANIM_WAVE)
        ...
        // ### Hentai ### BEGIN
        if(vwep->value && client->anim_priority == ANIM_REVERSE) 
	{
