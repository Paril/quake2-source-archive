...
extern qboolean bop_invisible;	// MATT's stuff...
...
//	self->solid = SOLID_NOT;
	...
	// MATT removing my custom power-ups
	reset_bop_counters(self);
...
//	ent->svflags &= ~SVF_NOCLIENT;	// MATT (not necessary)
...
void ClientBeginDeathmatch (edict_t *ent)
{
	...
	sl_WriteStdLogPlayerEntered( &gi, level, ent );	// StdLog schlop

	// MATT
	do_greeting(ent);	// give player a greeting...
